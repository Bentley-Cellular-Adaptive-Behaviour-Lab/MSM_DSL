...
public final class Amount_Concentration__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x3236b0e3fbdf4a71L, 0x8bfb69d9a5a4f1beL, 0xb839ee2c0e6f5b8L, "UnitLang.structure.Amount_Concentration");
  ...
  /*package*/ static BigDecimal convert_amount_id7Eknuda0FC6(@NotNull SNode __thisNode__, SNode current_unit, SNode target_unit) {
    BigDecimal target_value = Amount_Concentration__BehaviorDescriptor.get_amountconc_value_decimal_id7Eknuda0RxM.invoke(__thisNode__);
    int current_unit_val = Amount_Concentration__BehaviorDescriptor.get_amount_unit_val_id7Eknuda10hH.invoke(__thisNode__, current_unit);
    int target_unit_val = Amount_Concentration__BehaviorDescriptor.get_amount_unit_val_id7Eknuda10hH.invoke(__thisNode__, target_unit);
  ...
  /*package*/ static Integer get_amount_unit_val_id7Eknuda10hH(@NotNull SNode __thisNode__, SNode unit) {
    int val = -1;
  ...
  /*package*/ static BigDecimal convert_metre_volume_id7Eknuda1mi6(@NotNull SNode __thisNode__, SNode current_unit, SNode target_unit) {
    BigDecimal target_value = Amount_Concentration__BehaviorDescriptor.get_amountconc_value_decimal_id7Eknuda0RxM.invoke(__thisNode__);
    int current_unit_val = Amount_Concentration__BehaviorDescriptor.get_metre_unit_val_id7Eknuda11po.invoke(__thisNode__, current_unit);
    int target_unit_val = Amount_Concentration__BehaviorDescriptor.get_metre_unit_val_id7Eknuda11po.invoke(__thisNode__, target_unit);
  ...
  /*package*/ static Integer get_metre_unit_val_id7Eknuda11po(@NotNull SNode __thisNode__, SNode unit) {
    int val = -1;
  ...
  /*package*/ static BigDecimal convert_litre_volume_id7Eknuda1oOk(@NotNull SNode __thisNode__, SNode current_unit, SNode target_unit) {
    BigDecimal target_value = Amount_Concentration__BehaviorDescriptor.get_amountconc_value_decimal_id7Eknuda0RxM.invoke(__thisNode__);
    int current_unit_val = Amount_Concentration__BehaviorDescriptor.get_litre_unit_val_id7Eknuda1gz5.invoke(__thisNode__, current_unit);
    int target_unit_val = Amount_Concentration__BehaviorDescriptor.get_litre_unit_val_id7Eknuda1gz5.invoke(__thisNode__, target_unit);
  ...
  /*package*/ static Integer get_litre_unit_val_id7Eknuda1gz5(@NotNull SNode __thisNode__, SNode unit) {
    int val = -1;
  ...
  /*package*/ static BigDecimal get_amountconc_value_decimal_id7Eknuda0RxM(@NotNull SNode __thisNode__) {
    Object value = IETS3ExprEvalHelper.evaluate(SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, LINKS.value$X0Sw), LINKS.expr$WZts));
  ...
  /*package*/ Amount_Concentration__BehaviorDescriptor() {
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) ((BigDecimal) convert_amount_id7Eknuda0FC6(node, (SNode) parameters[0], (SNode) parameters[1]));
      case 1:
        return (T) ((Integer) get_amount_unit_val_id7Eknuda10hH(node, (SNode) parameters[0]));
      case 2:
        return (T) ((BigDecimal) convert_metre_volume_id7Eknuda1mi6(node, (SNode) parameters[0], (SNode) parameters[1]));
      case 3:
        return (T) ((Integer) get_metre_unit_val_id7Eknuda11po(node, (SNode) parameters[0]));
      case 4:
        return (T) ((BigDecimal) convert_litre_volume_id7Eknuda1oOk(node, (SNode) parameters[0], (SNode) parameters[1]));
      case 5:
        return (T) ((Integer) get_litre_unit_val_id7Eknuda1gz5(node, (SNode) parameters[0]));
      case 6:
        return (T) ((BigDecimal) get_amountconc_value_decimal_id7Eknuda0RxM(node));
      case 7:
        return (T) ((Boolean) is_less_than_zero_id7Eknuda1vdB(node));
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept Moles$YW = MetaAdapterFactory.getConcept(0x3236b0e3fbdf4a71L, 0x8bfb69d9a5a4f1beL, 0xb839ee2c0e6f5a8L, "UnitLang.structure.Moles");
    /*package*/ static final SConcept Millimoles$Zr = MetaAdapterFactory.getConcept(0x3236b0e3fbdf4a71L, 0x8bfb69d9a5a4f1beL, 0xb839ee2c0e6f5a9L, "UnitLang.structure.Millimoles");
    /*package*/ static final SConcept Micromoles$dO = MetaAdapterFactory.getConcept(0x3236b0e3fbdf4a71L, 0x8bfb69d9a5a4f1beL, 0x622035beb7ca54f0L, "UnitLang.structure.Micromoles");
    /*package*/ static final SConcept Nanomoles$ej = MetaAdapterFactory.getConcept(0x3236b0e3fbdf4a71L, 0x8bfb69d9a5a4f1beL, 0x622035beb7ca54f1L, "UnitLang.structure.Nanomoles");
