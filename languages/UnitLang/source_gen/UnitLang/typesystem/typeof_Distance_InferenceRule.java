...
public class typeof_Distance_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode distance, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    // Forces distances to be real numbers.
    {
      ...
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:bae71dfe-8677-4e04-ac6e-73e2082bf09f(UnitLang.typesystem)", "5497703887388107921", 0, null);
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:bae71dfe-8677-4e04-ac6e-73e2082bf09f(UnitLang.typesystem)", "5497703887388107927", true), (SNode) PTF.createRealType(null), false, true, _info_12389875345);
    }
  }
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept Distance$mo = MetaAdapterFactory.getConcept(0x3236b0e3fbdf4a71L, 0x8bfb69d9a5a4f1beL, 0x2f6b1b828a2c7667L, "UnitLang.structure.Distance");
  }
}
