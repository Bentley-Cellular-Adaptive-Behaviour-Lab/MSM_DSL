...
public class typeof_Volume_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode volume, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    // Forces volumes to be floats.
    {
      ...
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:bae71dfe-8677-4e04-ac6e-73e2082bf09f(UnitLang.typesystem)", "8832787999960419645", 0, null);
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:bae71dfe-8677-4e04-ac6e-73e2082bf09f(UnitLang.typesystem)", "8832787999960419647", true), (SNode) PTF.createRealType(null), false, true, _info_12389875345);
    }
  }
