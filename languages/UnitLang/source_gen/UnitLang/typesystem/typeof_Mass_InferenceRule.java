...
public class typeof_Mass_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode mass, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    // Forces mass values to be real numbers.
    {
      ...
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:bae71dfe-8677-4e04-ac6e-73e2082bf09f(UnitLang.typesystem)", "8832787999960420806", 0, null);
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:bae71dfe-8677-4e04-ac6e-73e2082bf09f(UnitLang.typesystem)", "8832787999960420808", true), (SNode) PTF.createRealType(null), false, true, _info_12389875345);
    }
  }
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept Mass$AP = MetaAdapterFactory.getConcept(0x3236b0e3fbdf4a71L, 0x8bfb69d9a5a4f1beL, 0xb839ee2c0e6f5c5L, "UnitLang.structure.Mass");
  }
}
