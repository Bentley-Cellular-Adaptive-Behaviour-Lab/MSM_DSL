...
public class typeof_Amount_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode amount, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    // Forces amounts (which are always expressed in moles) to be real numbers.
    {
      ...
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:bae71dfe-8677-4e04-ac6e-73e2082bf09f(UnitLang.typesystem)", "8832787999960421924", 0, null);
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:bae71dfe-8677-4e04-ac6e-73e2082bf09f(UnitLang.typesystem)", "8832787999960421926", true), (SNode) PTF.createRealType(null), false, true, _info_12389875345);
    }
  }
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.Amount$p;
  }
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept Amount$p = MetaAdapterFactory.getConcept(0x3236b0e3fbdf4a71L, 0x8bfb69d9a5a4f1beL, 0xb839ee2c0e6f5abL, "UnitLang.structure.Amount");
  }
}
