...
public final class Cell__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xb1ff4d68a5194928L, 0x8e36de776040fb5aL, 0x56b8f8b9a96cef88L, "TissueLang.structure.Cell");

  public static final SMethod<Boolean> check_object_boundaries_id1QpPlI51TK3 = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("check_object_boundaries").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1QpPlI51TK3").build();
  public static final SMethod<Boolean> check_upperx_world_boundary_id3$QBVvWCJog = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("check_upperx_world_boundary").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3$QBVvWCJog").build();
  public static final SMethod<Boolean> check_lowerx_world_boundary_id3$QBVvWCTDn = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("check_lowerx_world_boundary").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3$QBVvWCTDn").build();
  public static final SMethod<Boolean> check_uppery_world_boundary_id3$QBVvWCLp9 = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("check_uppery_world_boundary").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3$QBVvWCLp9").build();
  public static final SMethod<Boolean> check_lowery_world_boundary_id3$QBVvWCYG5 = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("check_lowery_world_boundary").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3$QBVvWCYG5").build();
  public static final SMethod<Boolean> check_upperz_world_boundary_id2xqP3eG0Qp1 = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("check_upperz_world_boundary").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("2xqP3eG0Qp1").build();
  public static final SMethod<Boolean> check_lowerz_world_boundary_id3$QBVvWCOcR = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("check_lowerz_world_boundary").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3$QBVvWCOcR").build();
  public static final SMethod<BigDecimal> get_cell_lowerx_decimal_id1QpPlI524fx = new SMethodBuilder<BigDecimal>(new SJavaCompoundTypeImpl(BigDecimal.class)).name("get_cell_lowerx_decimal").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1QpPlI524fx").build();
  public static final SMethod<Integer> get_cell_lowerx_gridpoint_id57WjpeqmNIV = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("get_cell_lowerx_gridpoint").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("57WjpeqmNIV").build();
  public static final SMethod<BigDecimal> get_cell_lowery_decimal_id1QpPlI524ju = new SMethodBuilder<BigDecimal>(new SJavaCompoundTypeImpl(BigDecimal.class)).name("get_cell_lowery_decimal").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1QpPlI524ju").build();
  public static final SMethod<Integer> get_cell_lowery_gridpoint_id57WjpeqmZqc = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("get_cell_lowery_gridpoint").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("57WjpeqmZqc").build();
  public static final SMethod<BigDecimal> get_cell_upperx_decimal_id1QpPlI524rF = new SMethodBuilder<BigDecimal>(new SJavaCompoundTypeImpl(BigDecimal.class)).name("get_cell_upperx_decimal").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1QpPlI524rF").build();
  public static final SMethod<Integer> get_cell_upperx_gridpoint_id57Wjpeqnkzu = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("get_cell_upperx_gridpoint").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("57Wjpeqnkzu").build();
  public static final SMethod<BigDecimal> get_cell_uppery_decimal_id1QpPlI524zL = new SMethodBuilder<BigDecimal>(new SJavaCompoundTypeImpl(BigDecimal.class)).name("get_cell_uppery_decimal").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1QpPlI524zL").build();
  public static final SMethod<Integer> get_cell_uppery_gridpoint_id57WjpeqnoVB = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("get_cell_uppery_gridpoint").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("57WjpeqnoVB").build();
