...
/*package*/ class Arrangement_Cylindrical_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Arrangement_Cylindrical_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_6asmbt_a");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_6asmbt_a0");
  ...
  private EditorCell createTooltip_0(final EditorContext editorContext, final SNode node) {
    LazyTooltipCellEvaluator tooltip = new LazyTooltipCellEvaluator(editorContext, node, "TissueLang.editor.GeneratedHints.tooltipHint_6asmbt_a0a", true);
    ...
    editorCell.setCellId("Tooltip_6asmbt_a0a");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Cylindrical");
    editorCell.setCellId("Constant_6asmbt_a0a0");
    Style style = new StyleImpl();
  ...
  private static class Cylinder_RadiusSingleRoleHandler_6asmbt_c2a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.Cylinder_Radius$5MFi, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.Cylinder_Radius$5MFi, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.Cylinder_Radius$5MFi);
      }
      Style style = new StyleImpl();
      style.set(StyleAttributes.FONT_FAMILY, "Calibri");
      style.set(StyleAttributes.FONT_SIZE, 16);
    ...
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.Cylinder_Radius$5MFi));
      try {
        EditorCell editorCell = super.createEmptyCell();
        editorCell.setCellId("empty_Cylinder_Radius");
