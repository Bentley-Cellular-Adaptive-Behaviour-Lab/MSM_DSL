...
public class noTissueObjectCollision_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  public noTissueObjectCollision_NonTypesystemRule() {
  }
    ...
    if ((boolean) Tissue__BehaviorDescriptor.check_object_boundaries_id1QpPlI51TNW.invoke(tissue)) {
      {
        ...
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(tissue, "Tissue overlaps with another cell or tissue in the container. Please check locations and boundaries.", "r:583b5986-f053-4561-9682-b6e844b2b168(TissueLang.typesystem)", "4122658121470114194", null, errorTarget);
      }
    }
  }
