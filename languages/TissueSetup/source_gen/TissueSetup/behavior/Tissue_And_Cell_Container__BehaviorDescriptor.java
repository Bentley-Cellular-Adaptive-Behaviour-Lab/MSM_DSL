...
public final class Tissue_And_Cell_Container__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> count_cell_number_id4XZPqyVOe45 = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("count_cell_number").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("4XZPqyVOe45").build();
