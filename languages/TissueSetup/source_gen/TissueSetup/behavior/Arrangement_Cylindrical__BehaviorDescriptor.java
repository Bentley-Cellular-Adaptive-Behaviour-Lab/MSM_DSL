...
public final class Arrangement_Cylindrical__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static int get_total_width_int_id1QpPlI52lcy(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getInteger(__thisNode__, PROPS.cylinder_length_in_cells$pzLn) * SPropertyOperations.getInteger(SNodeOperations.cast(SLinkOperations.getTarget(SLinkOperations.getTarget(SNodeOperations.getNodeAncestor(__thisNode__, CONCEPTS.Tissue_Type$C4, false, false), LINKS.cell_type$E3tO), LINKS.Shape$q0mn), CONCEPTS.Shape_Rectangular$1r), PROPS.width$pTZY);
  }
  /*package*/ static int calculate_cross_section_cells_id506$KtOAF5K(@NotNull SNode __thisNode__) {

    int cross_section_cells = ((int) Arrangement_Cylindrical__BehaviorDescriptor.calculate_total_ablumenal_steps_id506$KtO_VOJ.invoke(__thisNode__)) / SPropertyOperations.getInteger(SNodeOperations.cast(SLinkOperations.getTarget(SLinkOperations.getTarget(SNodeOperations.cast(SNodeOperations.getParent(__thisNode__), CONCEPTS.Tissue_Type$C4), LINKS.cell_type$E3tO), LINKS.Shape$q0mn), CONCEPTS.Shape_Rectangular$1r), PROPS.height$pTxW);
