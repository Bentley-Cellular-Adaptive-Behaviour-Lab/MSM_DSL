    ...
    if ((boolean) Tissue_And_Cell_Container__BehaviorDescriptor.check_positions_id1QpPlI51UW4.invoke(container)) {
      {
        ...
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(container, "Object collision detected.", "r:583b5986-f053-4561-9682-b6e844b2b168(TissueSetup.typesystem)", "7299877976789734942", null, errorTarget);
      }
    }
  }
