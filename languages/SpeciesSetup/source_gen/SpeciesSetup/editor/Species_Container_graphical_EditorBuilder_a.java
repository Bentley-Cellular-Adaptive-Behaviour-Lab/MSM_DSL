...
/*package*/ class Species_Container_graphical_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Species_Container_graphical_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
              ...
              public void run() {
                ContextVariables.withValue("thisNode", node, new Runnable() {
                  public void run() {
                      ...
                      public List<? extends IDiagramElementAccessor> getElements(IAccessorFactory accessorFactory) {
                        ...
                        for (final SNode parameterObject : new Object() {
                          public Iterable<SNode> query() {
                            return SLinkOperations.getChildren(node, LINKS.Reactions$ViS0);
                          }
                        }.query()) {
                          ContextVariables.withParentAndValue(_variablesContext, "parameterObject", parameterObject, new Runnable() {
                            public void run() {
                              final ContextVariables _variablesContext = ContextVariables.getCurrent();
                              final EditorCell editorCell = new Inline_Builder_6eee99_a0a(editorContext, parameterObject).createCell();
                        ...
                        for (final SNode parameterObject : new Object() {
                          public Iterable<SNode> query() {
                            return SLinkOperations.getChildren(node, LINKS.Species$VipY);
                          }
                        }.query()) {
                          ContextVariables.withParentAndValue(_variablesContext, "parameterObject", parameterObject, new Runnable() {
                            public void run() {
                              final ContextVariables _variablesContext = ContextVariables.getCurrent();
                              final EditorCell editorCell = new Inline_Builder_6eee99_a1a(editorContext, parameterObject).createCell();
                        ...
                        for (final SNode parameterObject : new Object() {
                          public Iterable<SNode> query() {
                            return SLinkOperations.collect(SLinkOperations.collectMany(SLinkOperations.getChildren(node, LINKS.Species$VipY), LINKS.reactantIn$IyJZ), LINKS.Reaction$q6q2);
                          }
                        }.query()) {
                          ContextVariables.withParentAndValue(_variablesContext, "parameterObject", parameterObject, new Runnable() {
                            public void run() {
                              ...
                              editorCell.setCellId("transformedGraphElement_c0" + "." + SPropertyOperations.getString(((SNode) _variablesContext.getValue("parameterObject")), PROPS.name$MnvL) + "_" + SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getParent(((SNode) _variablesContext.getValue("parameterObject"))), CONCEPTS.Species$kW), PROPS.name$MnvL) + "_reactantRelation");


                              final IShape startShape = null;
                              final IShape endShape = new Arrowhead(1.0, true, 2.0);
                              AbstractEdgeAccessor accessor = new AbstractEdgeAccessor(new AccessorKey(SPropertyOperations.getString(((SNode) _variablesContext.getValue("parameterObject")), PROPS.name$MnvL) + "_" + SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getParent(((SNode) _variablesContext.getValue("parameterObject"))), CONCEPTS.Species$kW), PROPS.name$MnvL) + "_reactantRelation")) {
                                @Override
                                ...
                                public IConnectionEndpointReference readFrom() {
                                  return EndpointUtil.createEndpointReferenceForIdSafe(SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getParent(((SNode) _variablesContext.getValue("parameterObject"))), CONCEPTS.Species$kW), PROPS.name$MnvL));
                                }
                                @Override
                        ...
                        for (final SNode parameterObject : new Object() {
                          public Iterable<SNode> query() {
                            return SLinkOperations.collect(SLinkOperations.collect(SLinkOperations.collectMany(SLinkOperations.getChildren(node, LINKS.Reactions$ViS0), LINKS.Product_Terms$6O0a), LINKS.Species_Ref$6VJc), LINKS.Species$q080);
                          }
                        }.query()) {
                          ContextVariables.withParentAndValue(_variablesContext, "parameterObject", parameterObject, new Runnable() {
                            public void run() {
                              final ContextVariables _variablesContext = ContextVariables.getCurrent();
                              final EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(editorContext, parameterObject);
                              editorCell.setCellId("transformedGraphElement_d0" + "." + SPropertyOperations.getString(((SNode) _variablesContext.getValue("parameterObject")), PROPS.name$MnvL) + "_" + SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getParent(((SNode) _variablesContext.getValue("parameterObject"))), CONCEPTS.Reaction$lr), PROPS.name$MnvL) + "_relation");


                              final IShape startShape = null;
                              final IShape endShape = new Arrowhead(1.0, true, 2.0);
                              AbstractEdgeAccessor accessor = new AbstractEdgeAccessor(new AccessorKey(SPropertyOperations.getString(((SNode) _variablesContext.getValue("parameterObject")), PROPS.name$MnvL) + "_" + SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getParent(((SNode) _variablesContext.getValue("parameterObject"))), CONCEPTS.Reaction$lr), PROPS.name$MnvL) + "_relation")) {
                                @Override
                                public void writeFrom(IConnectionEndpoint_Internal endpoint) {
                                  writeFrom(EndpointUtil.getSNode(endpoint), EndpointUtil.getPortName(endpoint));
                                }
                                ...
                                @Override
                                public IConnectionEndpointReference readFrom() {
                                  return EndpointUtil.createEndpointReferenceForIdSafe(SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getParent(((SNode) _variablesContext.getValue("parameterObject"))), CONCEPTS.Reaction$lr), PROPS.name$MnvL));
                                }
                                @Override
                                public IConnectionEndpointReference readTo() {
                                  return EndpointUtil.createEndpointReferenceForIdSafe(SPropertyOperations.getString(((SNode) _variablesContext.getValue("parameterObject")), PROPS.name$MnvL));
                    ...
                    DiagramModel model = DiagramModel.getModel(editorContext, node, "3989375547140064492", accessor);

                    IPaletteEntryProvider paletteEntryProvider = new CompositePaletteEntryProvider(new SubstituteInfoPaletteEntryProvider(new SubstituteInfoFactory(editorContext, node).forChildLink(node, SLinkOperations.findLinkDeclaration(LINKS.Reactions$ViS0))), new SubstituteInfoPaletteEntryProvider(new SubstituteInfoFactory(editorContext, node).forChildLink(node, SLinkOperations.findLinkDeclaration(LINKS.Species$VipY))));
                    ...
                    editorCell.value.setCellId("Diagram_6eee99_a");
  ...
  /*package*/ static class Inline_Builder_6eee99_a0a extends AbstractEditorBuilder {
    @NotNull
    private SNode myNode;

    /*package*/ Inline_Builder_6eee99_a0a(@NotNull EditorContext context, @NotNull SNode node) {
      super(context);
      myNode = node;
    }
    ...
    private EditorCell createCollection_0() {
      ...
      editorCell.setCellId("Collection_6eee99_a0a0");
    ...
    private EditorCell createConstant_0() {
      ...
      editorCell.setCellId("Constant_6eee99_a0a0a");
      editorCell.setDefaultText("");
      return editorCell;
    }
    private EditorCell createCollection_1() {
      EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
      editorCell.setCellId("Collection_6eee99_b0a0a");
    ...
    private EditorCell createConstant_1() {
      ...
      editorCell.setCellId("Constant_6eee99_a1a0a0");
      editorCell.setDefaultText("");
      return editorCell;
    }
  ...
  /*package*/ static class Inline_Builder_6eee99_a1a extends AbstractEditorBuilder {
    @NotNull
    private SNode myNode;

    /*package*/ Inline_Builder_6eee99_a1a(@NotNull EditorContext context, @NotNull SNode node) {
      super(context);
      myNode = node;
    }
    ...
    private EditorCell createCollection_2() {
      EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Vertical());
      editorCell.setCellId("Collection_6eee99_a0b0");
    ...
    private EditorCell createConstant_2() {
      ...
      editorCell.setCellId("Constant_6eee99_a0a1a");
      editorCell.setDefaultText("");
      return editorCell;
    }
    private EditorCell createCollection_3() {
      EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
      editorCell.setCellId("Collection_6eee99_b0a1a");
      Style style = new StyleImpl();
      style.set(StyleAttributes.SELECTABLE, false);
      editorCell.getStyle().putAll(style);
    ...
    private EditorCell createConstant_3() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Name :");
      editorCell.setCellId("Constant_6eee99_a1a0b0");
      editorCell.setDefaultText("");
      return editorCell;
    }
    ...
    private EditorCell createCollection_4() {
      EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
      editorCell.setCellId("Collection_6eee99_c0a1a");
      Style style = new StyleImpl();
      style.set(StyleAttributes.SELECTABLE, false);
      editorCell.getStyle().putAll(style);
    ...
    private EditorCell createConstant_4() {
      ...
      editorCell.setCellId("Constant_6eee99_a2a0b0");
      editorCell.setDefaultText("");
      return editorCell;
    }
    ...
    private EditorCell createCollection_5() {
      EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
      editorCell.setCellId("Collection_6eee99_d0a1a");
      Style style = new StyleImpl();
      style.set(StyleAttributes.SELECTABLE, false);
      editorCell.getStyle().putAll(style);
    ...
    private EditorCell createConstant_5() {
      ...
      editorCell.setCellId("Constant_6eee99_a3a0b0");
      editorCell.setDefaultText("");
      return editorCell;
    }
    private EditorCell createRefNode_0() {
      SingleRoleCellProvider provider = new Starting_ConcentrationSingleRoleHandler_6eee99_b3a0b0(myNode, LINKS.Starting_Concentration$ul34, getEditorContext());
      return provider.createCell();
    }
    private static class Starting_ConcentrationSingleRoleHandler_6eee99_b3a0b0 extends SingleRoleCellProvider {
      @NotNull
      private SNode myNode;

      public Starting_ConcentrationSingleRoleHandler_6eee99_b3a0b0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SContainmentLink Product_Terms$6O0a = MetaAdapterFactory.getContainmentLink(0xf3f95abcaef14f78L, 0xaa77fb36d4ba916aL, 0x2b6159d0ceea4df1L, 0x2b6159d0ceea4e05L, "Product_Terms");
