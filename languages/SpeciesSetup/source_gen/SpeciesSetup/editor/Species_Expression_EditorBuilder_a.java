...
/*package*/ class Species_Expression_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Species_Expression_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_bzuc7c_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_bzuc7c_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.Species$8XOa;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.Species$8XOa);
    }
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "]");
    editorCell.setCellId("Constant_bzuc7c_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
