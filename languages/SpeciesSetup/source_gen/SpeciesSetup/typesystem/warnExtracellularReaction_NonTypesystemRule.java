    ...
    if (extracellularSpeciesCount > SLinkOperations.getChildren(reaction, LINKS.Reactant_Terms$Wnv9).size()) {
      {
        ...
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportWarning(reaction, "Including only extracellular species in a reaction will have no effect.", "r:9e0fbf2a-b9f3-458b-86a2-82f541ac8497(SpeciesSetup.typesystem)", "1155607132034041718", null, errorTarget);
      }
    }
  }
