...
public class check_ReactionHasProducts_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  public check_ReactionHasProducts_NonTypesystemRule() {
  }
  public void applyRule(final SNode reaction, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    if (Objects.equals(ListSequence.fromList(SLinkOperations.getChildren(reaction, LINKS.Product_Terms$WnXb)).count(), 0)) {
      {
        final MessageTarget errorTarget = new NodeMessageTarget();
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(reaction, "Reactions must have at least one product.", "r:9e0fbf2a-b9f3-458b-86a2-82f541ac8497(SpeciesSetup.typesystem)", "599534810093896239", null, errorTarget);
      }
    }
  }
