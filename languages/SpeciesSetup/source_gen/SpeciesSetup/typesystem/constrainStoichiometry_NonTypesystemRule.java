    ...
    if (SPropertyOperations.getInteger(term, PROPS.Stoichiometry$Wmha) < 1) {
      {
        ...
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(term, "Stoichiometry must be greater than 0.", "r:9e0fbf2a-b9f3-458b-86a2-82f541ac8497(SpeciesSetup.typesystem)", "1155607132028382745", null, errorTarget);
      }
    }
  }
