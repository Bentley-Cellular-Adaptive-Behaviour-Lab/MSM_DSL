        ...
        if (Objects.equals(SLinkOperations.getTarget(usesParam, LINKS.target$9wsE), SLinkOperations.getTarget(usedByParam, LINKS.target$9wsE))) {
          {
            ...
            IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(parameter, "This parameter cannot use and be used by parameter : " + SPropertyOperations.getString(SLinkOperations.getTarget(usesParam, LINKS.target$9wsE), PROPS.name$MnvL), "r:9e0fbf2a-b9f3-458b-86a2-82f541ac8497(SpeciesSetup.typesystem)", "544738612548202390", null, errorTarget);
          }
        }
      }
    }
