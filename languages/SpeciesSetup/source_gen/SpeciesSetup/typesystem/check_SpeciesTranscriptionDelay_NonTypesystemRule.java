    ...
    if (SPropertyOperations.getInteger(species, PROPS.Transcription_Delay$D$oz) < 1) {
      {
        ...
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(species, "Transcription delays must be greater than zero.", "r:9e0fbf2a-b9f3-458b-86a2-82f541ac8497(SpeciesSetup.typesystem)", "6420553392044114741", null, errorTarget);
      }
    }
  }
