...
import WorldLang.behavior.Adhesiveness__BehaviorDescriptor;
...
import WorldLang.behavior.Gradient_Shape_Cuboidal__BehaviorDescriptor;
import WorldLang.behavior.Gradient_Shape_Point__BehaviorDescriptor;
import WorldLang.behavior.Substrate_Shape_Cuboid__BehaviorDescriptor;
import WorldLang.behavior.Vertex__BehaviorDescriptor;
import WorldLang.behavior.Substrate_Shape_Triangular__BehaviorDescriptor;
import WorldLang.behavior.Substrate__BehaviorDescriptor;
...
public class QueriesGenerated extends QueryProviderBase {
  ...
  public static Object propertyMacro_GetValue_1_12(final PropertyMacroContext _context) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.SpeciesReference$1HMH), LINKS.target$26Ka), PROPS.name$MnvL);
  }
  ...
  public static Object propertyMacro_GetValue_1_14(final PropertyMacroContext _context) {
    if (SEnumOperations.isMember(SPropertyOperations.getEnum(SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.SpeciesReference$1HMH), LINKS.target$26Ka), PROPS.Location$Gx$s), 0x2b6159d0ceed39a8L)) {
      return "PROTEIN_LOCATION_ENVIRONMENT";
    } else if (SEnumOperations.isMember(SPropertyOperations.getEnum(SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.SpeciesReference$1HMH), LINKS.target$26Ka), PROPS.Location$Gx$s), 0x2b6159d0ceed39a9L)) {
      return "PROTEIN_LOCATION_MEMBRANE";
    } else if (SEnumOperations.isMember(SPropertyOperations.getEnum(SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.SpeciesReference$1HMH), LINKS.target$26Ka), PROPS.Location$Gx$s), 0x2b6159d0ceed39acL)) {
      return "PROTEIN_LOCATION_CELL";
    } else if (SEnumOperations.isMember(SPropertyOperations.getEnum(SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.SpeciesReference$1HMH), LINKS.target$26Ka), PROPS.Location$Gx$s), 0x2b6159d0ceed39b0L)) {
  ...
  public static Object propertyMacro_GetValue_1_15(final PropertyMacroContext _context) {
    return String.valueOf((float) Species__BehaviorDescriptor.getStartConcentrationValue_id3fk35jmCFN3.invoke(SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.SpeciesReference$1HMH), LINKS.target$26Ka)));
  }
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept Substrate_Shape_Cuboid$DK = MetaAdapterFactory.getConcept(0x276cd304748c4d5dL, 0xaad04b34e2a42cedL, 0x51ca2b62e9a67f50L, "WorldLang.structure.Substrate_Shape_Cuboid");
    ...
    /*package*/ static final SConcept Gradient_Type_Constant$aC = MetaAdapterFactory.getConcept(0x276cd304748c4d5dL, 0xaad04b34e2a42cedL, 0x28d0502d0d028b08L, "WorldLang.structure.Gradient_Type_Constant");
    /*package*/ static final SConcept Gradient_Type_Custom$$t = MetaAdapterFactory.getConcept(0x276cd304748c4d5dL, 0xaad04b34e2a42cedL, 0x28d0502d0d028ba2L, "WorldLang.structure.Gradient_Type_Custom");
    /*package*/ static final SConcept Gradient_Type_Linear$GA = MetaAdapterFactory.getConcept(0x276cd304748c4d5dL, 0xaad04b34e2a42cedL, 0x28d0502d0d028af4L, "WorldLang.structure.Gradient_Type_Linear");
    /*package*/ static final SConcept Gradient_Type_Exponential$g0 = MetaAdapterFactory.getConcept(0x276cd304748c4d5dL, 0xaad04b34e2a42cedL, 0x28d0502d0d028b68L, "WorldLang.structure.Gradient_Type_Exponential");
    /*package*/ static final SConcept Gradient_Shape_Cuboidal$1m = MetaAdapterFactory.getConcept(0x276cd304748c4d5dL, 0xaad04b34e2a42cedL, 0x28d0502d0d1213c6L, "WorldLang.structure.Gradient_Shape_Cuboidal");
    /*package*/ static final SConcept Gradient_Shape_Point$wx = MetaAdapterFactory.getConcept(0x276cd304748c4d5dL, 0xaad04b34e2a42cedL, 0x28d0502d0d028bcaL, "WorldLang.structure.Gradient_Shape_Point");
  }
}
