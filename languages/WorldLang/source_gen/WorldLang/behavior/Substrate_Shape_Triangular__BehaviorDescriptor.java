...
public final class Substrate_Shape_Triangular__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x276cd304748c4d5dL, 0xaad04b34e2a42cedL, 0x51ca2b62e9a67f4fL, "WorldLang.structure.Substrate_Shape_Triangular");

  public static final SMethod<BigDecimal> get_vertex1x_decimal_id57aaQbDEkks = new SMethodBuilder<BigDecimal>(new SJavaCompoundTypeImpl(BigDecimal.class)).name("get_vertex1x_decimal").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("57aaQbDEkks").build();
  public static final SMethod<String> get_vertex1x_string_id3wWy5vw2hFm = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("get_vertex1x_string").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3wWy5vw2hFm").build();
  public static final SMethod<BigDecimal> get_vertex1y_decimal_id3wWy5vw2lIl = new SMethodBuilder<BigDecimal>(new SJavaCompoundTypeImpl(BigDecimal.class)).name("get_vertex1y_decimal").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3wWy5vw2lIl").build();
  public static final SMethod<String> get_vertex1y_string_id57aaQbDElMG = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("get_vertex1y_string").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("57aaQbDElMG").build();
  public static final SMethod<BigDecimal> get_vertex2x_decimal_id3wWy5vw2w5e = new SMethodBuilder<BigDecimal>(new SJavaCompoundTypeImpl(BigDecimal.class)).name("get_vertex2x_decimal").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3wWy5vw2w5e").build();
  public static final SMethod<String> get_vertex2X_string_id3wWy5vw2w5C = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("get_vertex2X_string").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3wWy5vw2w5C").build();
  public static final SMethod<BigDecimal> get_vertex2y_decimal_id3wWy5vw2w5T = new SMethodBuilder<BigDecimal>(new SJavaCompoundTypeImpl(BigDecimal.class)).name("get_vertex2y_decimal").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3wWy5vw2w5T").build();
  public static final SMethod<String> get_vertex2y_string_id3wWy5vw2w6j = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("get_vertex2y_string").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3wWy5vw2w6j").build();
  public static final SMethod<BigDecimal> get_vertex3x_decimal_id3wWy5vw2_jP = new SMethodBuilder<BigDecimal>(new SJavaCompoundTypeImpl(BigDecimal.class)).name("get_vertex3x_decimal").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3wWy5vw2_jP").build();
  public static final SMethod<String> get_vertex3x_string_id3wWy5vw2_kf = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("get_vertex3x_string").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3wWy5vw2_kf").build();
  public static final SMethod<BigDecimal> get_vertex3y_decimal_id3wWy5vw2_kw = new SMethodBuilder<BigDecimal>(new SJavaCompoundTypeImpl(BigDecimal.class)).name("get_vertex3y_decimal").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3wWy5vw2_kw").build();
  public static final SMethod<String> get_vertex3y_string_id3wWy5vw2_kU = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("get_vertex3y_string").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3wWy5vw2_kU").build();
  public static final SMethod<String> get_prism_depth_string_id4JVq81FgwNn = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("get_prism_depth_string").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("4JVq81FgwNn").build();
  public static final SMethod<BigDecimal> get_prism_depth_decimal_id1r0uutBHYjr = new SMethodBuilder<BigDecimal>(new SJavaCompoundTypeImpl(BigDecimal.class)).name("get_prism_depth_decimal").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1r0uutBHYjr").build();
  public static final SMethod<Integer> get_prism_zlocation_gridpoints_id11q$FfsSMHt = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("get_prism_zlocation_gridpoints").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("11q$FfsSMHt").build();
  public static final SMethod<Integer> get_prism_depth_gridpoints_idfEhJG2G3wz = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("get_prism_depth_gridpoints").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("fEhJG2G3wz").build();
  public static final SMethod<BigDecimal> get_prism_zcoord_decimal_id3wWy5vw3Cyg = new SMethodBuilder<BigDecimal>(new SJavaCompoundTypeImpl(BigDecimal.class)).name("get_prism_zcoord_decimal").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3wWy5vw3Cyg").build();
  public static final SMethod<String> get_prism_zcoord_string_id3wWy5vw3KqH = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("get_prism_zcoord_string").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3wWy5vw3KqH").build();
  public static final SMethod<BigDecimal> get_prism_upperz_decimal_id2B5sNxPo4s_ = new SMethodBuilder<BigDecimal>(new SJavaCompoundTypeImpl(BigDecimal.class)).name("get_prism_upperz_decimal").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("2B5sNxPo4s_").build();
  public static final SMethod<Integer> get_prism_upperz_gridpoint_id11q$FfsSLP4 = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("get_prism_upperz_gridpoint").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("11q$FfsSLP4").build();
  public static final SMethod<String> get_prism_upperz_string_id1r0uutBI3Q2 = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("get_prism_upperz_string").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1r0uutBI3Q2").build();
  public static final SMethod<BigDecimal> get_prism_lowerz_decimal_id2B5sNxPo7PW = new SMethodBuilder<BigDecimal>(new SJavaCompoundTypeImpl(BigDecimal.class)).name("get_prism_lowerz_decimal").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("2B5sNxPo7PW").build();
  public static final SMethod<String> get_prism_lowerz_string_id1r0uutBN2EH = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("get_prism_lowerz_string").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1r0uutBN2EH").build();
  public static final SMethod<Integer> get_prism_lowerz_gridpoint_id11q$FfsSUmC = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("get_prism_lowerz_gridpoint").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("11q$FfsSUmC").build();
