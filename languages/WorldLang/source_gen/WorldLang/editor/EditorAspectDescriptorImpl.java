...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase implements EditorHintsProvider {
  private Collection<ConceptEditorHint> myHints = Arrays.<ConceptEditorHint>asList(new ConceptEditorHintImpl("tooltipHint_qumq7g_b2a", "", false, "WorldLang.editor.GeneratedHints.tooltipHint_qumq7g_b2a"), new ConceptEditorHintImpl("tooltipHint_qumq7g_b4a", "", false, "WorldLang.editor.GeneratedHints.tooltipHint_qumq7g_b4a"), new ConceptEditorHintImpl("tooltipHint_qumq7g_b6a", "", false, "WorldLang.editor.GeneratedHints.tooltipHint_qumq7g_b6a"), new ConceptEditorHintImpl("tooltipHint_qumq7g_a0i0", "", false, "WorldLang.editor.GeneratedHints.tooltipHint_qumq7g_a0i0"), new ConceptEditorHintImpl("tooltipHint_koct37_a0a", "", false, "WorldLang.editor.GeneratedHints.tooltipHint_koct37_a0a"), new ConceptEditorHintImpl("tooltipHint_koct37_a1a", "", false, "WorldLang.editor.GeneratedHints.tooltipHint_koct37_a1a"), new ConceptEditorHintImpl("tooltipHint_koct37_a2a", "", false, "WorldLang.editor.GeneratedHints.tooltipHint_koct37_a2a"), new ConceptEditorHintImpl("tooltipHint_koct37_a3a", "", false, "WorldLang.editor.GeneratedHints.tooltipHint_koct37_a3a"), new ConceptEditorHintImpl("tooltipHint_fphtn9_b2a", "", false, "WorldLang.editor.GeneratedHints.tooltipHint_fphtn9_b2a"));
  @NotNull
  ...
  private Collection<ConceptEditorComponent> getDeclaredEC_0(String editorComponentId) {
    if ("WorldLang.editor.DummyForGrammarCells".equals(editorComponentId)) {
  ...
  private static final ConceptSwitchIndex conceptIndex2 = new ConceptSwitchIndexBuilder().put(MetaIdFactory.conceptId(0x276cd304748c4d5dL, 0xaad04b34e2a42cedL, 0x4c33c9dac8771740L), MetaIdFactory.conceptId(0x276cd304748c4d5dL, 0xaad04b34e2a42cedL, 0x73ca99e5119b19e3L)).seal();
}
