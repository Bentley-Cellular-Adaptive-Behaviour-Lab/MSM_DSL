...
/*package*/ class Grid_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createTooltip_0(final EditorContext editorContext, final SNode node) {
    LazyTooltipCellEvaluator tooltip = new LazyTooltipCellEvaluator(editorContext, node, "WorldLang.editor.GeneratedHints.tooltipHint_koct37_a0a", true);
  ...
  private EditorCell createTooltip_2(final EditorContext editorContext, final SNode node) {
    LazyTooltipCellEvaluator tooltip = new LazyTooltipCellEvaluator(editorContext, node, "WorldLang.editor.GeneratedHints.tooltipHint_koct37_a1a", true);
  ...
  private EditorCell createTooltip_4(final EditorContext editorContext, final SNode node) {
    LazyTooltipCellEvaluator tooltip = new LazyTooltipCellEvaluator(editorContext, node, "WorldLang.editor.GeneratedHints.tooltipHint_koct37_a2a", true);
  ...
  private EditorCell createTooltip_6(final EditorContext editorContext, final SNode node) {
    LazyTooltipCellEvaluator tooltip = new LazyTooltipCellEvaluator(editorContext, node, "WorldLang.editor.GeneratedHints.tooltipHint_koct37_a3a", true);
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept Adhesiveness$m0 = MetaAdapterFactory.getConcept(0x276cd304748c4d5dL, 0xaad04b34e2a42cedL, 0x2f6b1b828a3a33b6L, "WorldLang.structure.Adhesiveness");
