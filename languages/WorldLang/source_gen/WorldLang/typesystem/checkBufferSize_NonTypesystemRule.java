...
import WorldLang.behavior.Grid__BehaviorDescriptor;
    ...
    if ((int) Grid__BehaviorDescriptor.get_buffer_gridpoint_size_id11q$FfsTmr2.invoke(grid) < 0) {
      {
        ...
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(SLinkOperations.getTarget(grid, LINKS.Buffer$9SPv), "Buffer size cannot be less than 0.", "r:ac2b9fac-3bf9-494e-8c49-b2bd8239392c(WorldLang.typesystem)", "3967240825596490510", null, errorTarget);
      }
    }
  }
