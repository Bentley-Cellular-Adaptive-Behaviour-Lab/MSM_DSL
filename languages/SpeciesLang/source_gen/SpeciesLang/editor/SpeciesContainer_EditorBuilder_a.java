...
/*package*/ class SpeciesContainer_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_8() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_jaklk3_i0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_17() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Using Tissue Set-up:");
    editorCell.setCellId("Constant_jaklk3_a8a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.FONT_FAMILY, "Calibri");
    style.set(StyleAttributes.FONT_SIZE, 16);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.Tissue_Container$Ds8T;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.Tissue_Container$Ds8T);
    ...
    provider.setNoTargetText("<no Tissue_Container>");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.Tissue_Container$Ds8T);
    }
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept Process$y1 = MetaAdapterFactory.getConcept(0x84970ad9a9644f15L, 0xa393dc0fcd724c0fL, 0x54e0a6c6049cf033L, "SpeciesLang.structure.Process");
