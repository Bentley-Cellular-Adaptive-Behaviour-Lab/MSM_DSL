...
/*package*/ class SpeciesReference_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public SpeciesReference_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_yd2hpa_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_yd2hpa_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.target$26Ka;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.target$26Ka);
    }
