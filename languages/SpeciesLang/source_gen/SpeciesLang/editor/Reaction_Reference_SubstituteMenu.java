...
public class Reaction_Reference_SubstituteMenu extends SubstituteMenuBase {
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for Reaction_Reference. Generated from implicit smart reference attribute.", new SNodePointer("r:d106886d-5be7-42b5-b3d4-98be927e7b91(SpeciesLang.structure)", "1878314651098778609")));
    try {
