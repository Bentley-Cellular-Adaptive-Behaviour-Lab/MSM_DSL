...
/*package*/ class Species_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_nkm0p4_b1a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.FONT_FAMILY, "Calibri");
    style.set(StyleAttributes.FONT_SIZE, 16);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new Starting_ConcentrationSingleRoleHandler_nkm0p4_c2a(myNode, LINKS.Starting_Concentration$a3uk, getEditorContext());
    return provider.createCell();
  }
  private static class Starting_ConcentrationSingleRoleHandler_nkm0p4_c2a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public Starting_ConcentrationSingleRoleHandler_nkm0p4_c2a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_6() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Production Rate:");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.Production_Term$Cs3S;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.Production_Term$Cs3S);
    ...
    provider.setNoTargetText("<no Production_Term>");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.Production_Term$Cs3S);
    }
  ...
  private EditorCell createConstant_7() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Degradation Rate:");
  ...
  private EditorCell createRefCell_1() {
    final SReferenceLink referenceLink = LINKS.Degradation_Term$Cd2S;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
        ...
        }, targetNode, LINKS.Degradation_Term$Cd2S);
        CellUtil.setupIDeprecatableStyles(targetNode, cell);
        setSemanticNodeToCells(cell, getNode());
        installDeleteActions_nullable_reference(cell);
        return cell;
    ...
    provider.setNoTargetText("<no Degradation_Term>");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.Degradation_Term$Cd2S);
    }
    editorCell.setSubstituteInfo(new SReferenceSubstituteInfo(editorCell, referenceLink));
    Iterable<SNode> referenceAttributes = SNodeOperations.ofConcept(new IAttributeDescriptor.AllAttributes().list(myNode), CONCEPTS.LinkAttribute$v_);
    Iterable<SNode> currentReferenceAttributes = Sequence.fromIterable(referenceAttributes).where(new IWhereFilter<SNode>() {
  ...
  private EditorCell createConstant_8() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Transcription Delay:");
  ...
  private EditorCell createProperty_4() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.Transcription_Delay$D$oz;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("<no Transcription_Delay>");
      editorCell.setCellId("property_Transcription_Delay");
      Style style = new StyleImpl();
      style.set(StyleAttributes.FONT_FAMILY, "Calibri");
      style.set(StyleAttributes.FONT_SIZE, 16);
