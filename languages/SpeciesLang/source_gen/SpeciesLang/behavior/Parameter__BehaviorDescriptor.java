...
public final class Parameter__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x84970ad9a9644f15L, 0xa393dc0fcd724c0fL, 0x2b6159d0ceecf4f1L, "SpeciesLang.structure.Parameter");
  ...
  /*package*/ static void addUsesRelations_idufje78jt14(@NotNull SNode __thisNode__, List<SNode> usesParameters) {
    for (SNode parameter : ListSequence.fromList(usesParameters)) {
      ...
      if (!(isAlreadyStored)) {
        SNode newRef = SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0x84970ad9a9644f15L, 0xa393dc0fcd724c0fL, 0x65d0f96c4dec199dL, "SpeciesLang.structure.ParameterReference"));
