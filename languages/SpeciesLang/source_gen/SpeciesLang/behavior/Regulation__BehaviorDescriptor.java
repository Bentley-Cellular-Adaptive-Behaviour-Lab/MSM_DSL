...
public final class Regulation__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x84970ad9a9644f15L, 0xa393dc0fcd724c0fL, 0x54e0a6c604985928L, "SpeciesLang.structure.Regulation");
  ...
  /*package*/ static void createRelations_id20T6jFVkE_s(@NotNull SNode __thisNode__) {
    ...
    if (!(isAlreadyPresent)) {
      SNode sourceRef = SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0x84970ad9a9644f15L, 0xa393dc0fcd724c0fL, 0x2039193afb4c33c3L, "SpeciesLang.structure.RegulationReference"));
    ...
    if (!(isAlreadyPresent)) {
      SNode targetRef = SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0x84970ad9a9644f15L, 0xa393dc0fcd724c0fL, 0x2039193afb4c33c3L, "SpeciesLang.structure.RegulationReference"));
