...
public final class Reaction_Term__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x84970ad9a9644f15L, 0xa393dc0fcd724c0fL, 0x2b6159d0ceecf4f2L, "SpeciesLang.structure.Reaction_Term");
  ...
  private static void ___init___(@NotNull SNode __thisNode__) {
    SPropertyOperations.assign(__thisNode__, PROPS.UsesNeighbourValue$$pnR, false);
  }
  ...
  /*package*/ static void create_relation_id1Ch7j$N9XgT(@NotNull SNode __thisNode__) {
    ...
    if ((SLinkOperations.getTarget(__thisNode__, LINKS.Species_Ref$Wnde) != null) && !(((boolean) Reaction_Term__BehaviorDescriptor.isRelationPresent_id1Ch7j$NgJ_b.invoke(__thisNode__)))) {
      SNode newReactionRef = SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0x84970ad9a9644f15L, 0xa393dc0fcd724c0fL, 0x1a111d3933278bf1L, "SpeciesLang.structure.Reaction_Reference"));
