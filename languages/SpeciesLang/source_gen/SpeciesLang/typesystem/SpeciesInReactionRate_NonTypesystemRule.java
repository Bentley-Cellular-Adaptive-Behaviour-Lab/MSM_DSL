...
import SpeciesLang.behavior.IrreversibleReaction__BehaviorDescriptor;
import jetbrains.mps.errors.messageTargets.MessageTarget;
import jetbrains.mps.errors.messageTargets.NodeMessageTarget;
import jetbrains.mps.errors.IErrorReporter;
import jetbrains.mps.lang.smodel.generator.smodelAdapter.SPropertyOperations;
import SpeciesLang.behavior.ReversibleReaction__BehaviorDescriptor;
      ...
      if (SNodeOperations.isInstanceOf(Process, CONCEPTS.IrreversibleReaction$ja)) {
          ...
          if (!((boolean) IrreversibleReaction__BehaviorDescriptor.rateContainsSpecies_id4Q3VeFU210_.invoke(SNodeOperations.as(Process, CONCEPTS.IrreversibleReaction$ja), species))) {
            {
              ...
              IErrorReporter _reporter_2309309498 = typeCheckingContext.reportWarning(Process, "Rate does not use species: " + SPropertyOperations.getString(species, PROPS.name$MnvL), "r:9e0fbf2a-b9f3-458b-86a2-82f541ac8497(SpeciesLang.typesystem)", "5585568456831110333", null, errorTarget);
            }
          }
        }
        ...
        for (SNode term : ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.as(Process, CONCEPTS.ReversibleReaction$fi), LINKS.Reactant_Terms$Wnv9))) {
          ...
          if (!((boolean) ReversibleReaction__BehaviorDescriptor.forwardRateContainsSpecies_id4Q3VeFU2gYQ.invoke(SNodeOperations.as(Process, CONCEPTS.ReversibleReaction$fi), species))) {
            {
              final MessageTarget errorTarget = new NodeMessageTarget();
              IErrorReporter _reporter_2309309498 = typeCheckingContext.reportWarning(Process, "Forward rate does not use species: " + SPropertyOperations.getString(species, PROPS.name$MnvL), "r:9e0fbf2a-b9f3-458b-86a2-82f541ac8497(SpeciesLang.typesystem)", "583075595212481494", null, errorTarget);
            }
          }
        }
        for (SNode term : ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.as(Process, CONCEPTS.ReversibleReaction$fi), LINKS.Product_Terms$WnXb))) {
          ...
          if (!((boolean) ReversibleReaction__BehaviorDescriptor.reverseRateContainsSpecies_id4Q3VeFU2l6w.invoke(SNodeOperations.as(Process, CONCEPTS.ReversibleReaction$fi), species))) {
            {
              final MessageTarget errorTarget = new NodeMessageTarget();
              IErrorReporter _reporter_2309309498 = typeCheckingContext.reportWarning(Process, "Reverse rate does not use species: " + SPropertyOperations.getString(species, PROPS.name$MnvL), "r:9e0fbf2a-b9f3-458b-86a2-82f541ac8497(SpeciesLang.typesystem)", "583075595212481522", null, errorTarget);
            }
          }
        }
      }
