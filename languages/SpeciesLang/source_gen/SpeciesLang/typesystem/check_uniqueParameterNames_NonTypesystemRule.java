    ...
    for (SNode currentParam : ListSequence.fromList(SLinkOperations.getChildren(container, LINKS.Parameters$hoyh))) {
        ...
        if (Objects.equals(SPropertyOperations.getString(currentParam, PROPS.name$MnvL), SPropertyOperations.getString(queryParam, PROPS.name$MnvL)) && !(Objects.equals(currentParam, queryParam))) {
          {
            ...
            IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(currentParam, "Parameter names must be unique.", "r:9e0fbf2a-b9f3-458b-86a2-82f541ac8497(SpeciesLang.typesystem)", "8050503989174892104", null, errorTarget);
          }
        }
      }
      for (SNode querySpecies : ListSequence.fromList(SLinkOperations.getChildren(container, LINKS.Species$hnnc))) {
        if (Objects.equals(SPropertyOperations.getString(currentParam, PROPS.name$MnvL), SPropertyOperations.getString(querySpecies, PROPS.name$MnvL))) {
          {
            final MessageTarget errorTarget = new NodeMessageTarget();
            IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(currentParam, "Parameter names must be unique.", "r:9e0fbf2a-b9f3-458b-86a2-82f541ac8497(SpeciesLang.typesystem)", "8015826073200015159", null, errorTarget);
          }
        }
      }
      for (SNode queryProcess : ListSequence.fromList(SLinkOperations.getChildren(container, LINKS.Processes$hnPe))) {
        if (Objects.equals(SPropertyOperations.getString(currentParam, PROPS.name$MnvL), SPropertyOperations.getString(queryProcess, PROPS.name$MnvL))) {
          {
            final MessageTarget errorTarget = new NodeMessageTarget();
            IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(currentParam, "Parameter names must be unique.", "r:9e0fbf2a-b9f3-458b-86a2-82f541ac8497(SpeciesLang.typesystem)", "8015826073200018963", null, errorTarget);
          }
        }
      }
    }
