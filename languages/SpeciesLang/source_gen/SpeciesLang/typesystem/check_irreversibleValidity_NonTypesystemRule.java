...
public class check_irreversibleValidity_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  public check_irreversibleValidity_NonTypesystemRule() {
  }
      ...
      for (SNode reactantTerm : ListSequence.fromList(SLinkOperations.getChildren(reaction, LINKS.Reactant_Terms$Wnv9))) {
        ...
        for (SNode productTerm : ListSequence.fromList(SLinkOperations.getChildren(reaction, LINKS.Product_Terms$WnXb))) {
          ...
          if (SPropertyOperations.getEnum(reactantSpecies, PROPS.Location$Gx$s).equals(SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0x84970ad9a9644f15L, 0xa393dc0fcd724c0fL, 0x2b6159d0ceed39a7L, "SpeciesLang.structure.SpeciesLocation"), 0x2b6159d0ceed39a8L, "LOCATION_EXTRACELLULAR_ENVIRONMENT"))) {
            ...
            if (SPropertyOperations.getEnum(productSpecies, PROPS.Location$Gx$s).equals(SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0x84970ad9a9644f15L, 0xa393dc0fcd724c0fL, 0x2b6159d0ceed39a7L, "SpeciesLang.structure.SpeciesLocation"), 0x2b6159d0ceed39a8L, "LOCATION_EXTRACELLULAR_ENVIRONMENT"))) {
              {
                final MessageTarget errorTarget = new NodeMessageTarget();
                IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(reaction, "Cell interior proteins cannot interact with protein " + SPropertyOperations.getString(SLinkOperations.getTarget(productTerm, LINKS.Species_Ref$Wnde), PROPS.name$MnvL) + ". Check " + SPropertyOperations.getString(SLinkOperations.getTarget(productTerm, LINKS.Species_Ref$Wnde), PROPS.name$MnvL) + "'s location is not the environment.", "r:9e0fbf2a-b9f3-458b-86a2-82f541ac8497(SpeciesLang.typesystem)", "665779027268592764", null, errorTarget);
              }
            }
  ...
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.IrreversibleReaction$ja;
  }
