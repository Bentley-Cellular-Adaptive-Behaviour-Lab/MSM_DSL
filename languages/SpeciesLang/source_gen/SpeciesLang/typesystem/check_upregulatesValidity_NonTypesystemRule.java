  ...
  public void applyRule(final SNode upregulates, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    try {
      ...
      if (SPropertyOperations.getEnum(SLinkOperations.getTarget(upregulates, LINKS.Source$9HG6), PROPS.Location$Gx$s).equals(SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0x84970ad9a9644f15L, 0xa393dc0fcd724c0fL, 0x2b6159d0ceed39a7L, "SpeciesLang.structure.SpeciesLocation"), 0x2b6159d0ceed39a8L, "LOCATION_EXTRACELLULAR_ENVIRONMENT"))) {
        ...
        if (SPropertyOperations.getEnum(SLinkOperations.getTarget(upregulates, LINKS.Target$9C3I), PROPS.Location$Gx$s).equals(SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0x84970ad9a9644f15L, 0xa393dc0fcd724c0fL, 0x2b6159d0ceed39a7L, "SpeciesLang.structure.SpeciesLocation"), 0x2b6159d0ceed39a8L, "LOCATION_EXTRACELLULAR_ENVIRONMENT")) || SPropertyOperations.getEnum(SLinkOperations.getTarget(upregulates, LINKS.Target$9C3I), PROPS.Location$Gx$s).equals(SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0x84970ad9a9644f15L, 0xa393dc0fcd724c0fL, 0x2b6159d0ceed39a7L, "SpeciesLang.structure.SpeciesLocation"), 0x2b6159d0ceed39acL, "LOCATION_CELLULAR_INTERIOR")) || SPropertyOperations.getEnum(SLinkOperations.getTarget(upregulates, LINKS.Target$9C3I), PROPS.Location$Gx$s).equals(SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0x84970ad9a9644f15L, 0xa393dc0fcd724c0fL, 0x2b6159d0ceed39a7L, "SpeciesLang.structure.SpeciesLocation"), 0x2b6159d0ceed39b0L, "LOCATION_CELL_JUNCTION"))) {
          {
            final MessageTarget errorTarget = new NodeMessageTarget();
            IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(upregulates, "Environment proteins cannot interact with protein " + SPropertyOperations.getString(SLinkOperations.getTarget(upregulates, LINKS.Target$9C3I), PROPS.name$MnvL) + ". Check " + SPropertyOperations.getString(SLinkOperations.getTarget(upregulates, LINKS.Target$9C3I), PROPS.name$MnvL) + "'s location is not the environment, the cell interior or cell junction.", "r:9e0fbf2a-b9f3-458b-86a2-82f541ac8497(SpeciesLang.typesystem)", "665779027268539420", null, errorTarget);
          }
        }
