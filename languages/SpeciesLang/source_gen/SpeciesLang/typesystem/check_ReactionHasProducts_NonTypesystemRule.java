    ...
    if (Objects.equals(ListSequence.fromList(SLinkOperations.getChildren(reaction, LINKS.Product_Terms$WnXb)).count(), 0)) {
      {
        ...
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(reaction, "Reactions must have at least one product.", "r:9e0fbf2a-b9f3-458b-86a2-82f541ac8497(SpeciesLang.typesystem)", "599534810093896239", null, errorTarget);
      }
    }
  }
