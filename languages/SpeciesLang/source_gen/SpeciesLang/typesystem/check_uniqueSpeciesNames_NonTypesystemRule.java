    ...
    for (SNode currentSpecies : ListSequence.fromList(SLinkOperations.getChildren(container, LINKS.Species$hnnc))) {
        ...
        if (Objects.equals(SPropertyOperations.getString(currentSpecies, PROPS.name$MnvL), SPropertyOperations.getString(querySpecies, PROPS.name$MnvL)) && !(Objects.equals(currentSpecies, querySpecies))) {
          {
            ...
            IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(currentSpecies, "Species names must be unique.", "r:9e0fbf2a-b9f3-458b-86a2-82f541ac8497(SpeciesLang.typesystem)", "8050503989175226172", null, errorTarget);
          }
        }
      }
      for (SNode currentProcess : ListSequence.fromList(SLinkOperations.getChildren(container, LINKS.Processes$hnPe))) {
        if (Objects.equals(SPropertyOperations.getString(currentSpecies, PROPS.name$MnvL), SPropertyOperations.getString(currentProcess, PROPS.name$MnvL))) {
          {
            final MessageTarget errorTarget = new NodeMessageTarget();
            IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(currentSpecies, "Species names must be unique.", "r:9e0fbf2a-b9f3-458b-86a2-82f541ac8497(SpeciesLang.typesystem)", "8015826073199958710", null, errorTarget);
          }
        }
      }
      for (SNode currentParameter : ListSequence.fromList(SLinkOperations.getChildren(container, LINKS.Parameters$hoyh))) {
        if (Objects.equals(SPropertyOperations.getString(currentSpecies, PROPS.name$MnvL), SPropertyOperations.getString(currentParameter, PROPS.name$MnvL))) {
          {
            final MessageTarget errorTarget = new NodeMessageTarget();
            IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(currentSpecies, "Species names must be unique.", "r:9e0fbf2a-b9f3-458b-86a2-82f541ac8497(SpeciesLang.typesystem)", "8015826073199963468", null, errorTarget);
          }
        }
      }
    }
