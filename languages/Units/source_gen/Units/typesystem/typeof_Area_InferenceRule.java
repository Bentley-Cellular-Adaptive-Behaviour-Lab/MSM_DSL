...
public class typeof_Area_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode area, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    // Forces areas to be integers. 
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:bae71dfe-8677-4e04-ac6e-73e2082bf09f(Units.typesystem)", "8832787999960418816", true), (SNode) PTF.createRealType(null), false, true, _info_12389875345);
    }
  }
