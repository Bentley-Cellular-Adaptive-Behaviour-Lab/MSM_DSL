...
import Units.behavior.Volume__BehaviorDescriptor;
    ...
    if ((boolean) Volume__BehaviorDescriptor.is_less_than_zero_id7Eknud9Z8oK.invoke(volume)) {
      {
        ...
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(volume, "Volumes cannot be less than zero.", "r:bae71dfe-8677-4e04-ac6e-73e2082bf09f(Units.typesystem)", "8832787999961282191", null, errorTarget);
      }
    }
  }
