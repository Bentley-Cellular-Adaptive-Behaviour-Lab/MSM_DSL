...
public class typeof_Amount_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode amount, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    // Forces amounts (which are always expressed in moles) to be real numbers. 
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:bae71dfe-8677-4e04-ac6e-73e2082bf09f(Units.typesystem)", "8832787999960421926", true), (SNode) PTF.createRealType(null), false, true, _info_12389875345);
    }
  }
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept Amount$p = MetaAdapterFactory.getConcept(0x3236b0e3fbdf4a71L, 0x8bfb69d9a5a4f1beL, 0xb839ee2c0e6f5abL, "Units.structure.Amount");
  }
}
