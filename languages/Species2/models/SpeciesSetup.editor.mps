  ...
  <node concept="24kQdi" id="2Hxmt3eVgJ7">
    ...
    <node concept="3EZMnI" id="2Hxmt3eVgJ9" role="2wV5jI">
      ...
      <node concept="3EZMnI" id="2Hxmt3eVgKg" role="3EZMnx">
        ...
        <node concept="3XFhqQ" id="109yD1sEHst" role="3EZMnx" />
        <node concept="1j7BWu" id="109yD1sCt07" role="3EZMnx">
          <node concept="3F0ifn" id="109yD1sCt0d" role="1j7Clw">
            <property role="3F0ifm" value="3. Define Parameters" />
            <node concept="VQ3r3" id="109yD1sCt0j" role="3F10Kt">
              <property role="2USNnj" value="gtbM8PH/underlined" />
            </node>
          </node>
          <node concept="3EZMnI" id="109yD1sCt0f" role="1j7ClA">
            <node concept="2iRkQZ" id="109yD1sCt0g" role="2iSdaV" />
            <node concept="3F0ifn" id="109yD1sCt0h" role="3EZMnx">
              <property role="3F0ifm" value="Create additional constants that can be used" />
            </node>
            <node concept="3F0ifn" id="109yD1sCt0k" role="3EZMnx">
              <property role="3F0ifm" value="to define reaction rates." />
            </node>
          </node>
        </node>
        <node concept="3F0ifn" id="109yD1sCt0n" role="3EZMnx">
          <property role="3F0ifm" value=":" />
        </node>
  ...
  <node concept="24kQdi" id="2Hxmt3eWvNW">
    ...
    <node concept="27vDVx" id="2Hxmt3eWvOc" role="2wV5jI">
      <node concept="1RuTs0" id="6pt0UY9xHUb" role="1RuSHk">
        <ref role="1RuSHD" to="w3cn:2Hxmt3eVft2" resolve="Reactions" />
      </node>
