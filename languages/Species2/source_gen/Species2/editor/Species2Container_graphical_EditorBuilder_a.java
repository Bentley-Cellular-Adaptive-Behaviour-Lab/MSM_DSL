...
/*package*/ class Species2Container_graphical_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Species2Container_graphical_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
              ...
              public void run() {
                ContextVariables.withValue("thisNode", node, new Runnable() {
                  public void run() {
                      ...
                      public List<? extends IDiagramElementAccessor> getElements(IAccessorFactory accessorFactory) {
                        ...
                        for (final SNode parameterObject : new Object() {
                          ...
                          ContextVariables.withParentAndValue(_variablesContext, "parameterObject", parameterObject, new Runnable() {
                            public void run() {
                              final ContextVariables _variablesContext = ContextVariables.getCurrent();
                              final EditorCell editorCell = new Inline_Builder_3q9cc6_a0a(editorContext, parameterObject).createCell();
                        ...
                        for (final SNode parameterObject : new Object() {
                          ...
                          ContextVariables.withParentAndValue(_variablesContext, "parameterObject", parameterObject, new Runnable() {
                            public void run() {
                              final ContextVariables _variablesContext = ContextVariables.getCurrent();
                              final EditorCell editorCell = new Inline_Builder_3q9cc6_a1a(editorContext, parameterObject).createCell();
                        ...
                        for (final SNode parameterObject : new Object() {
                          ...
                          ContextVariables.withParentAndValue(_variablesContext, "parameterObject", parameterObject, new Runnable() {
                            public void run() {
                              ...
                              editorCell.setCellId("transformedGraphElement_c0" + "." + SPropertyOperations.getString(SLinkOperations.getTarget(((SNode) _variablesContext.getValue("parameterObject")), LINKS.Species_Ref$Wnde), PROPS.name$MnvL) + "_" + SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getParent(((SNode) _variablesContext.getValue("parameterObject"))), CONCEPTS.Reaction$JH), PROPS.name$MnvL) + "_reactantRelation");

                              final EditorCell labelCell = DiagramUtil.getCellIfNotEmpty(new Inline_Builder_3q9cc6_a2a(editorContext, parameterObject).createCell());
                              if (labelCell != null) {
                        ...
                        for (final SNode parameterObject : new Object() {
                          ...
                          ContextVariables.withParentAndValue(_variablesContext, "parameterObject", parameterObject, new Runnable() {
                            public void run() {
                              final ContextVariables _variablesContext = ContextVariables.getCurrent();
                              final EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(editorContext, parameterObject);
                              editorCell.setCellId("transformedGraphElement_d0" + "." + SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getParent(((SNode) _variablesContext.getValue("parameterObject"))), CONCEPTS.Reaction$JH), PROPS.name$MnvL) + "_" + SPropertyOperations.getString(SLinkOperations.getTarget(((SNode) _variablesContext.getValue("parameterObject")), LINKS.Species_Ref$Wnde), PROPS.name$MnvL) + "_productRelation");

                              final EditorCell labelCell = DiagramUtil.getCellIfNotEmpty(new Inline_Builder_3q9cc6_a3a(editorContext, parameterObject).createCell());
                              if (labelCell != null) {
                                editorCell.addEditorCell(labelCell);
                              }
                    ...
                    editorCell.value.setCellId("Diagram_3q9cc6_a");
  ...
  /*package*/ static class Inline_Builder_3q9cc6_a0a extends AbstractEditorBuilder {
    @NotNull
    private SNode myNode;

    /*package*/ Inline_Builder_3q9cc6_a0a(@NotNull EditorContext context, @NotNull SNode node) {
      super(context);
      myNode = node;
    }
    ...
    private EditorCell createCollection_0() {
      ...
      editorCell.setCellId("Collection_3q9cc6_a0a0");
    ...
    private EditorCell createConstant_0() {
      ...
      editorCell.setCellId("Constant_3q9cc6_a0a0a");
      editorCell.setDefaultText("");
      return editorCell;
    }
    private EditorCell createCollection_1() {
      EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
      editorCell.setCellId("Collection_3q9cc6_b0a0a");
    ...
    private EditorCell createConstant_1() {
      ...
      editorCell.setCellId("Constant_3q9cc6_a1a0a0");
      editorCell.setDefaultText("");
      return editorCell;
    }
    ...
    private EditorCell createCollection_2() {
      EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
      editorCell.setCellId("Collection_3q9cc6_c0a0a");
      Style style = new StyleImpl();
      style.set(StyleAttributes.SELECTABLE, false);
      editorCell.getStyle().putAll(style);
    ...
    private EditorCell createConstant_2() {
      ...
      editorCell.setCellId("Constant_3q9cc6_a2a0a0");
      editorCell.setDefaultText("");
      return editorCell;
    }
    ...
    private EditorCell createCollection_3() {
      EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
      editorCell.setCellId("Collection_3q9cc6_d0a0a");
      Style style = new StyleImpl();
      style.set(StyleAttributes.SELECTABLE, false);
      editorCell.getStyle().putAll(style);
    ...
    private EditorCell createConstant_3() {
      ...
      editorCell.setCellId("Constant_3q9cc6_a3a0a0");
      editorCell.setDefaultText("");
      return editorCell;
    }
    private EditorCell createRefNode_0() {
      SingleRoleCellProvider provider = new Starting_ConcentrationSingleRoleHandler_3q9cc6_b3a0a0(myNode, LINKS.Starting_Concentration$a3uk, getEditorContext());
      return provider.createCell();
    }
    private static class Starting_ConcentrationSingleRoleHandler_3q9cc6_b3a0a0 extends SingleRoleCellProvider {
      @NotNull
      private SNode myNode;

      public Starting_ConcentrationSingleRoleHandler_3q9cc6_b3a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  /*package*/ static class Inline_Builder_3q9cc6_a1a extends AbstractEditorBuilder {
    @NotNull
    private SNode myNode;

    /*package*/ Inline_Builder_3q9cc6_a1a(@NotNull EditorContext context, @NotNull SNode node) {
      super(context);
      myNode = node;
    }
    ...
    private EditorCell createCollection_4() {
      EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Vertical());
      editorCell.setCellId("Collection_3q9cc6_a0b0");
    ...
    private EditorCell createConstant_4() {
      ...
      editorCell.setCellId("Constant_3q9cc6_a0a1a");
      editorCell.setDefaultText("");
      return editorCell;
    }
    private EditorCell createCollection_5() {
      EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
      editorCell.setCellId("Collection_3q9cc6_b0a1a");
      Style style = new StyleImpl();
      style.set(StyleAttributes.SELECTABLE, false);
      editorCell.getStyle().putAll(style);
    ...
    private EditorCell createConstant_5() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Name :");
      editorCell.setCellId("Constant_3q9cc6_a1a0b0");
      editorCell.setDefaultText("");
      return editorCell;
    }
  ...
  /*package*/ static class Inline_Builder_3q9cc6_a2a extends AbstractEditorBuilder {
    @NotNull
    private SNode myNode;

    /*package*/ Inline_Builder_3q9cc6_a2a(@NotNull EditorContext context, @NotNull SNode node) {
      super(context);
      myNode = node;
    }
  ...
  /*package*/ static class Inline_Builder_3q9cc6_a3a extends AbstractEditorBuilder {
    @NotNull
    private SNode myNode;

    /*package*/ Inline_Builder_3q9cc6_a3a(@NotNull EditorContext context, @NotNull SNode node) {
      super(context);
      myNode = node;
    }
