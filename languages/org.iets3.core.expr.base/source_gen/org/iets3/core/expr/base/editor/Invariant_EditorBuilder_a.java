...
/*package*/ class Invariant_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_d0hy86_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    editorCell.addEditorCell(createConstant_0());
    if (nodeCondition_d0hy86_a1a()) {
      editorCell.addEditorCell(createCustomFactory_1());
    }
    editorCell.addEditorCell(createRefNode_0());
    if (nodeCondition_d0hy86_a3a()) {
      editorCell.addEditorCell(createCustomFactory_3());
    }
    return editorCell;
  }
  private boolean nodeCondition_d0hy86_a1a() {
  ...
  private boolean nodeCondition_d0hy86_a3a() {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_d0hy86_a0");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new exprSingleRoleHandler_d0hy86_c0(myNode, LINKS.expr$Wyjb, getEditorContext());
    return provider.createCell();
  }
  private static class exprSingleRoleHandler_d0hy86_c0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public exprSingleRoleHandler_d0hy86_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createCollection_1() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_d0hy86_a0d0");
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_d0hy86_a0a3a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new errSingleRoleHandler_d0hy86_b0a3a(myNode, LINKS.err$phDR, getEditorContext());
    return provider.createCell();
  }
  private static class errSingleRoleHandler_d0hy86_b0a3a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public errSingleRoleHandler_d0hy86_b0a3a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
