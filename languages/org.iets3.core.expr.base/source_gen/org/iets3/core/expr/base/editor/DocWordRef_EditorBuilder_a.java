...
import org.iets3.core.expr.base.editor.wordStuff_StyleSheet.docWordStyleClass;
...
/*package*/ class DocWordRef_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public DocWordRef_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_z8etsd_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_z8etsd_a0");
    Style style = new StyleImpl();
    new docWordStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.node$xsqG;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.node$xsqG);
    }
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new ReferenceCellContext(getNode(), getNode(), referenceLink), new SubstituteInfoPartExt[]{new DocWordRef_node_cellMenu_z8etsd_a0b0(), new SChildSubstituteInfoPartEx(editorCell)}));
  ...
  public static class DocWordRef_node_cellMenu_z8etsd_a0b0 extends PrimaryReferentMenuCellMenuPart {
    public DocWordRef_node_cellMenu_z8etsd_a0b0() {
    }
    @NotNull
    @Override
    protected IReferentPresentationProvider getMatchingTextProvider() {
      return PresentationProviders.PRESENTATION_z8etsd_a0a1a;
    }
    @NotNull
    @Override
