...
/*package*/ class UnaryMinusExpression_EditorBuilder_a extends AbstractEditorBuilder {
      ...
      public EditorCell invoke() {
        ...
        cell.setSubstituteInfo(new ConstantSubstituteInfo(getEditorContext(), myNode) {
          ...
          public List<IToken> getSyntaxElementsAfter(SNode node) {
            List<IToken> result = ListSequence.fromList(new ArrayList<IToken>());
            ListSequence.fromList(result).addElement(new ChildToken(SLinkOperations.getTarget(node, LINKS.expr$Hji0)));
            return result;
          }
        });
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new exprSingleRoleHandler_p02nuh_b0(myNode, LINKS.expr$Hji0, getEditorContext());
