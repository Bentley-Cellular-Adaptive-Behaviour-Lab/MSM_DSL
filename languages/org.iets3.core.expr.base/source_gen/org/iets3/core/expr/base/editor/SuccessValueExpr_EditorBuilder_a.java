...
/*package*/ class SuccessValueExpr_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public SuccessValueExpr_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_ot5uno_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.try$MC5E;
    ...
    provider.setNoTargetText("<no try>");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.try$MC5E);
    }
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createProperty_0() {
      ...
      try {
        ...
        style.set(StyleAttributes.FONT_STYLE, _StyleParameter_QueryFunction_ot5uno_a0a0a0());
    ...
    private int _StyleParameter_QueryFunction_ot5uno_a0a0a0() {
      if ((boolean) IOptionallyNamed__BehaviorDescriptor.hasDefaultName_id3KzlhPzQWyE.invoke(getNode())) {
        return Font.BOLD;
      }
      return Font.PLAIN;
    }
