...
public class RangeTarget_Constraints extends BaseConstraintsDescriptor {
  public RangeTarget_Constraints() {
    super(CONCEPTS.RangeTarget$id);
  }
  ...
  private static boolean staticCanBeAChild(SNode node, SNode parentNode, SAbstractConcept childConcept, SContainmentLink link) {
    SNode tt = TypecheckingFacade.getFromContext().getTypeOf(SLinkOperations.getTarget(SNodeOperations.cast(parentNode, CONCEPTS.DotExpression$jp), LINKS.expr$Hji0));
    return PTF.isIntegerType(tt) || PTF.isRealType(tt);
  }
  private static final SNodePointer canBeChildBreakingPoint = new SNodePointer("r:9750d418-880f-460d-9880-d67dd111722d(org.iets3.core.expr.base.constraints)", "7126186526844787282");
