...
/*package*/ class LogicalNotExpression_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public LogicalNotExpression_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_7fsi6d_a");
      ...
      public EditorCell invoke() {
        cell.setAction(CellActionType.DELETE, new CellActionWithReadAccess() {
          public void execute(EditorContext editorContext) {
            ...
            SNode unwrapped = SNodeOperations.replaceWithAnother(node, SLinkOperations.getTarget(node, LINKS.expr$Hji0));
          ...
          public boolean canExecute_inReadAction(EditorContext editorContext) {
            ...
            SNode replacement = SLinkOperations.getTarget(node, LINKS.expr$Hji0);
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_7fsi6d_a0a");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new exprSingleRoleHandler_7fsi6d_b0(myNode, LINKS.expr$Hji0, getEditorContext());
    return provider.createCell();
  }
  private static class exprSingleRoleHandler_7fsi6d_b0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public exprSingleRoleHandler_7fsi6d_b0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
