...
public class DocWordRef_SmartReference extends SubstituteMenuBase {
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("named substitute menu " + "DocWordRef_SmartReference", new SNodePointer("r:8405f486-53b5-4fe6-af3e-7f68358bd631(org.iets3.core.expr.base.editor)", "8297803270191517133")));
    try {
  ...
  public class SMP_ReferenceScope_onzdy0_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_onzdy0_a() {
      ...
      super((SAbstractConcept) CONCEPTS.DocWordRef$7D, LINKS.node$xsqG);
    }
    @NotNull
    @Override
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
      context.getEditorMenuTrace().pushTraceInfo();
      context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:8405f486-53b5-4fe6-af3e-7f68358bd631(org.iets3.core.expr.base.editor)", "8297803270191517131")));
      try {
