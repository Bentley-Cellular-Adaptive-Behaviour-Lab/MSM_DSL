...
public final class SuccessValueExpr__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xcfaa4966b7d54b69L, 0xb66a309a6e1a7290L, 0x62632b96c1f940d6L, "org.iets3.core.expr.base.structure.SuccessValueExpr");
  ...
  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.try$MC5E), PROPS.name$MnvL);
  }

  /*package*/ SuccessValueExpr__BehaviorDescriptor() {
  }
