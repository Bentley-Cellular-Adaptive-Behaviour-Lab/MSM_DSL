...
public final class addInvariant_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  private Collection<IntentionExecutable> myCachedExecutable;
  public addInvariant_Intention() {
    super(Kind.NORMAL, true, new SNodePointer("r:7d06857c-251f-4454-ac9c-c398e5200a04(org.iets3.core.expr.base.intentions)", "3560002593017158226"));
  }
  @Override
  ...
  private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
    return (boolean) IContracted__BehaviorDescriptor.canHaveInvariant_idKaZMgy4IiZ.invoke(node);
  }
  @Override
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public String getDescription(final SNode node, final EditorContext editorContext) {
      return "ERROR HANDLING: " + ("Add Invariant");
    }
    @Override
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(node, LINKS.contract$U1k2), LINKS.items$WD4d)).addElement(createInvariant_gqwmxb_a0a1a0());
    }
    @Override
    public IntentionDescriptor getDescriptor() {
      return addInvariant_Intention.this;
    }
  }
  private static SNode createInvariant_gqwmxb_a0a1a0() {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.Invariant$I1);
