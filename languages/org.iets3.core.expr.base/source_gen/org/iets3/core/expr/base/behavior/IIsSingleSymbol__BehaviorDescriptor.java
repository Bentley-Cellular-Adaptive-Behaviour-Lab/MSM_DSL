...
public final class IIsSingleSymbol__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getSymbolName_id6XENO0rcSx = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getSymbolName").modifiers(SModifiersImpl.create(8, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("6XENO0rcSx").build();
