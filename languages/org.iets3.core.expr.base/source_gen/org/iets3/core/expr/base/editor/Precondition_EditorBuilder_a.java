...
/*package*/ class Precondition_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_vxkli2_a3a() {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_vxkli2_a0");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new exprSingleRoleHandler_vxkli2_c0(myNode, LINKS.expr$Wyjb, getEditorContext());
    return provider.createCell();
  }
  private static class exprSingleRoleHandler_vxkli2_c0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public exprSingleRoleHandler_vxkli2_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createCollection_1() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_vxkli2_a0d0");
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_vxkli2_a0a3a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new errSingleRoleHandler_vxkli2_b0a3a(myNode, LINKS.err$phDR, getEditorContext());
    return provider.createCell();
  }
  private static class errSingleRoleHandler_vxkli2_b0a3a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public errSingleRoleHandler_vxkli2_b0a3a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
