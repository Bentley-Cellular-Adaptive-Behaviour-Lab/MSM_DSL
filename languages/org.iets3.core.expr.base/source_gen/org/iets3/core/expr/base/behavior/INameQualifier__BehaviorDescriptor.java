...
public final class INameQualifier__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> makeQualifiedName_id4yaQL1YeoUt = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("makeQualifiedName").modifiers(SModifiersImpl.create(12, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("4yaQL1YeoUt").build(SMethodBuilder.createJavaParameter(String.class, ""));
