...
/*package*/ class ErrorLiteral_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public static class ErrorLiteral_name_cellMenu_pkhaj6_a0a extends AbstractCellMenuPart_PropertyValues {
    ...
    public List<String> getPropertyValues(SNode node, IOperationContext operationContext, EditorContext editorContext) {
      ...
      if ((te != null)) {
        ListSequence.fromList(proposals).addSequence(Sequence.fromIterable(TryExpression__BehaviorDescriptor.missingErrorClauses_id12WRc293Um2.invoke(te)).select(new ISelector<SNode, String>() {
          public String select(SNode it) {
            return SPropertyOperations.getString(it, PROPS.name$MnvL);
          }
        }));
      } else {
        ListSequence.fromList(proposals).addSequence(ListSequence.fromList(SModelOperations.nodesIncludingImported(SNodeOperations.getModel(node), CONCEPTS.ErrorLiteral$cb)).select(new ISelector<SNode, String>() {
          public String select(SNode it) {
            return SPropertyOperations.getString(it, PROPS.name$MnvL);
          }
        }).distinct());
