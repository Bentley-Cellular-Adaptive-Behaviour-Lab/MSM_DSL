...
public final class ICanBeLValue__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getInterfaceConcept(0xcfaa4966b7d54b69L, 0xb66a309a6e1a7290L, 0x2b547b5bcf93594L, "org.iets3.core.expr.base.structure.ICanBeLValue");
  ...
  public static final SMethod<Boolean> isUsedAsLValue_idYMJl2BJIOO = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("isUsedAsLValue").modifiers(SModifiersImpl.create(12, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("YMJl2BJIOO").build();
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(isLValue_idaPhVmWYjn5, isUsedAsLValue_idYMJl2BJIOO, assignmentProducedEffect_id1VmWkC0_H15);
  ...
  /*package*/ static EffectDescriptor assignmentProducedEffect_id1VmWkC0_H15(@NotNull SNode __thisNode__) {
    return EffectDescriptor.modifies();
  }

  /*package*/ ICanBeLValue__BehaviorDescriptor() {
  }
