...
/*package*/ class Source_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new positionSingleRoleHandler_x58f0o_a0(myNode, LINKS.position$ghW5, getEditorContext());
    return provider.createCell();
  }
  private static class positionSingleRoleHandler_x58f0o_a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public positionSingleRoleHandler_x58f0o_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createTooltip_0(final EditorContext editorContext, final SNode node) {
    LazyTooltipCellEvaluator tooltip = new LazyTooltipCellEvaluator(editorContext, node, "WorldSetup.editor.GeneratedHints.tooltipHint_x58f0o_c0", true);
    ...
    editorCell.setCellId("Tooltip_x58f0o_c0");
    return editorCell;
  }
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_x58f0o_a2a");
  ...
  private EditorCell createProperty_0() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.source_strength$KPNu;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("<no source_strength>");
      editorCell.setCellId("property_source_strength");
      Style style = new StyleImpl();
