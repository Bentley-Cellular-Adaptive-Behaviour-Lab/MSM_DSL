...
public class checkTriangularBoundaries_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode thisTriangular, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    int z_coord = ((int) IETS3ExprEvalHelper.evaluate(SLinkOperations.getTarget(SLinkOperations.getTarget(SLinkOperations.getTarget(thisTriangular, LINKS.Z_Location$8QOp), LINKS.value$SBs3), LINKS.expr$fJhI)));
    ...
    if (z_coord - SPropertyOperations.getInteger(thisTriangular, PROPS.depth$5OPS) / 2 < 0 || z_coord + SPropertyOperations.getInteger(thisTriangular, PROPS.depth$5OPS) / 2 > grid_z_size) {
      {
