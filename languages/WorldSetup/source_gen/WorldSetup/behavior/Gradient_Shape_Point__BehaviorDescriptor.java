...
public final class Gradient_Shape_Point__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<BigDecimal> get_point_centrex_decimal_id3wWy5vw6mLf = new SMethodBuilder<BigDecimal>(new SJavaCompoundTypeImpl(BigDecimal.class)).name("get_point_centrex_decimal").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3wWy5vw6mLf").build();
  public static final SMethod<String> get_point_centrex_string_id3wWy5vw6wW0 = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("get_point_centrex_string").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3wWy5vw6wW0").build();
  public static final SMethod<Integer> get_point_centrex_gridpoints_id57WjpeqpUiI = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("get_point_centrex_gridpoints").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("57WjpeqpUiI").build();
  public static final SMethod<BigDecimal> get_point_centrey_decimal_id3wWy5vw6oOc = new SMethodBuilder<BigDecimal>(new SJavaCompoundTypeImpl(BigDecimal.class)).name("get_point_centrey_decimal").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3wWy5vw6oOc").build();
  public static final SMethod<String> get_point_centrey_string_id3wWy5vw6y03 = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("get_point_centrey_string").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3wWy5vw6y03").build();
  public static final SMethod<Integer> get_point_centrey_gridpoints_id57WjpeqpYdC = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("get_point_centrey_gridpoints").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("57WjpeqpYdC").build();
  public static final SMethod<BigDecimal> get_point_centrez_decimal_id3wWy5vw6pvK = new SMethodBuilder<BigDecimal>(new SJavaCompoundTypeImpl(BigDecimal.class)).name("get_point_centrez_decimal").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3wWy5vw6pvK").build();
  public static final SMethod<String> get_point_centrez_string_id3wWy5vw6yQo = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("get_point_centrez_string").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3wWy5vw6yQo").build();
  public static final SMethod<Integer> get_point_centrez_gridpoints_id57WjpeqpYLl = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("get_point_centrez_gridpoints").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("57WjpeqpYLl").build();
  public static final SMethod<BigDecimal> get_point_radius_decimal_id3wWy5vw6pHU = new SMethodBuilder<BigDecimal>(new SJavaCompoundTypeImpl(BigDecimal.class)).name("get_point_radius_decimal").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3wWy5vw6pHU").build();
  public static final SMethod<String> get_point_radius_string_id3wWy5vw6$0J = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("get_point_radius_string").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3wWy5vw6$0J").build();
  public static final SMethod<Integer> get_point_radius_gridpoint_id57WjpeqpZlz = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("get_point_radius_gridpoint").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("57WjpeqpZlz").build();
  public static final SMethod<Integer> get_point_lowerx_gridpoint_id3V40ltqZX_8 = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("get_point_lowerx_gridpoint").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3V40ltqZX_8").build();
  public static final SMethod<Integer> get_point_lowery_gridpoint_id3V40ltqZXKj = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("get_point_lowery_gridpoint").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3V40ltqZXKj").build();
  public static final SMethod<Integer> get_point_lowerz_gridpoint_id3V40ltqZYtk = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("get_point_lowerz_gridpoint").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3V40ltqZYtk").build();
  public static final SMethod<Integer> get_point_upperx_gridpoint_id3V40ltqZZ20 = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("get_point_upperx_gridpoint").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3V40ltqZZ20").build();
  public static final SMethod<Integer> get_point_uppery_gridpoint_id3V40ltqZZ24 = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("get_point_uppery_gridpoint").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3V40ltqZZ24").build();
  public static final SMethod<Integer> get_point_upperz_gridpoint_id3V40ltqZZ28 = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("get_point_upperz_gridpoint").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3V40ltqZZ28").build();
