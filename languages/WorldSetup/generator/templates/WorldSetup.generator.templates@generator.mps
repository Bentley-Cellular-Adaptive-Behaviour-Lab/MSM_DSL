  ...
  <node concept="312cEu" id="2Nrf2jTWUKk">
    ...
    <node concept="2YIFZL" id="2Nrf2jTWWGi" role="jymVt">
      ...
      <node concept="3clFbS" id="2Nrf2jTWWGo" role="3clF47">
            ...
            <node concept="3clFbF" id="GHHs3T_vn4" role="3cqZAp">
              <node concept="2OqwBi" id="GHHs3T_vn5" role="3clFbG">
                ...
                <node concept="liA8E" id="GHHs3T_vn7" role="2OqNvi">
                  <ref role="37wK5l" to="wyt6:~ProcessBuilder.redirectErrorStream()" resolve="redirectErrorStream" />
                </node>
              </node>
            </node>
        ...
        <node concept="3clFbH" id="GHHs3TvpSQ" role="3cqZAp" />
        <node concept="3J1_TO" id="GHHs3TAcrk" role="3cqZAp">
          <node concept="3uVAMA" id="GHHs3TAcrl" role="1zxBo5">
            <node concept="XOnhg" id="GHHs3TAcrm" role="1zc67B">
              <property role="TrG5h" value="e" />
              <node concept="nSUau" id="GHHs3TAcrn" role="1tU5fm">
                <node concept="3uibUv" id="GHHs3TAcro" role="nSUat">
                  <ref role="3uigEE" to="guwi:~IOException" resolve="IOException" />
                </node>
              </node>
            </node>
            <node concept="3clFbS" id="GHHs3TAcrp" role="1zc67A">
              <node concept="3clFbF" id="GHHs3TAcrq" role="3cqZAp">
                <node concept="2OqwBi" id="GHHs3TAcrr" role="3clFbG">
                  <node concept="37vLTw" id="GHHs3TAcrs" role="2Oq$k0">
                    <ref role="3cqZAo" node="GHHs3TAcrm" resolve="e" />
                  </node>
                  <node concept="liA8E" id="GHHs3TAcrt" role="2OqNvi">
                    <ref role="37wK5l" to="wyt6:~Throwable.printStackTrace()" resolve="printStackTrace" />
                  </node>
                </node>
              </node>
          ...
          <node concept="3uVAMA" id="GHHs3TAcru" role="1zxBo5">
            <node concept="XOnhg" id="GHHs3TAcrv" role="1zc67B">
              <property role="TrG5h" value="e" />
              <node concept="nSUau" id="GHHs3TAcrw" role="1tU5fm">
                <node concept="3uibUv" id="GHHs3TAcrx" role="nSUat">
                  <ref role="3uigEE" to="wyt6:~InterruptedException" resolve="InterruptedException" />
                </node>
              </node>
            </node>
            <node concept="3clFbS" id="GHHs3TAcry" role="1zc67A">
              <node concept="3clFbF" id="GHHs3TAcrz" role="3cqZAp">
                <node concept="2OqwBi" id="GHHs3TAcr$" role="3clFbG">
                  <node concept="37vLTw" id="GHHs3TAcr_" role="2Oq$k0">
                    <ref role="3cqZAo" node="GHHs3TAcrv" resolve="e" />
                  </node>
                  <node concept="liA8E" id="GHHs3TAcrA" role="2OqNvi">
                    <ref role="37wK5l" to="wyt6:~Throwable.printStackTrace()" resolve="printStackTrace" />
                  </node>
                </node>
              </node>
          ...
          <node concept="3clFbS" id="GHHs3TAcrB" role="1zxBo7">
            <node concept="3cpWs8" id="GHHs3TAcrC" role="3cqZAp">
              <node concept="3cpWsn" id="GHHs3TAcrD" role="3cpWs9">
                <property role="TrG5h" value="pb" />
                <node concept="3uibUv" id="GHHs3TAcrE" role="1tU5fm">
                  <ref role="3uigEE" to="wyt6:~ProcessBuilder" resolve="ProcessBuilder" />
                </node>
                <node concept="2ShNRf" id="GHHs3TAcrF" role="33vP2m">
                  <node concept="1pGfFk" id="GHHs3TAcrG" role="2ShVmc">
                    <ref role="37wK5l" to="wyt6:~ProcessBuilder.&lt;init&gt;(java.lang.String...)" resolve="ProcessBuilder" />
                    <node concept="Xl_RD" id="GHHs3TAcrH" role="37wK5m">
                      <property role="Xl_RC" value="sh" />
                    </node>
                    <node concept="Xl_RD" id="GHHs3TAcrI" role="37wK5m">
                      <property role="Xl_RC" value="buildSpringAgent" />
                    </node>
                    <node concept="Xl_RD" id="GHHs3TAcrJ" role="37wK5m">
                      <property role="Xl_RC" value="--analysis==\&quot;time_to_pattern\&quot;" />
                    </node>
                  </node>
                </node>
            ...
            <node concept="3clFbF" id="GHHs3TAcrK" role="3cqZAp">
              <node concept="2OqwBi" id="GHHs3TAcrL" role="3clFbG">
                <node concept="37vLTw" id="GHHs3TAcrM" role="2Oq$k0">
                  <ref role="3cqZAo" node="GHHs3TAcrD" resolve="pb" />
                </node>
                <node concept="liA8E" id="GHHs3TAcrN" role="2OqNvi">
                  <ref role="37wK5l" to="wyt6:~ProcessBuilder.redirectErrorStream()" resolve="redirectErrorStream" />
                </node>
              </node>
            </node>
            <node concept="3cpWs8" id="GHHs3TAcrO" role="3cqZAp">
              <node concept="3cpWsn" id="GHHs3TAcrP" role="3cpWs9">
                <property role="TrG5h" value="p" />
                <node concept="3uibUv" id="GHHs3TAcrQ" role="1tU5fm">
                  <ref role="3uigEE" to="wyt6:~Process" resolve="Process" />
                </node>
                <node concept="2OqwBi" id="GHHs3TAcrR" role="33vP2m">
                  <node concept="37vLTw" id="GHHs3TAcrS" role="2Oq$k0">
                    <ref role="3cqZAo" node="GHHs3TAcrD" resolve="pb" />
                  </node>
                  <node concept="liA8E" id="GHHs3TAcrT" role="2OqNvi">
            ...
            <node concept="3cpWs8" id="GHHs3TAcrU" role="3cqZAp">
              <node concept="3cpWsn" id="GHHs3TAcrV" role="3cpWs9">
                <property role="TrG5h" value="input_stream" />
                <node concept="3uibUv" id="GHHs3TAcrW" role="1tU5fm">
                  <ref role="3uigEE" to="guwi:~InputStream" resolve="InputStream" />
                </node>
                <node concept="2OqwBi" id="GHHs3TAcrX" role="33vP2m">
                  <node concept="37vLTw" id="GHHs3TAcrY" role="2Oq$k0">
                    <ref role="3cqZAo" node="GHHs3TAcrP" resolve="p" />
                  </node>
                  <node concept="liA8E" id="GHHs3TAcrZ" role="2OqNvi">
                    <ref role="37wK5l" to="wyt6:~Process.getInputStream()" resolve="getInputStream" />
                  </node>
                </node>
              </node>
            </node>
            <node concept="3cpWs8" id="GHHs3TAcs0" role="3cqZAp">
              <node concept="3cpWsn" id="GHHs3TAcs1" role="3cpWs9">
                <property role="TrG5h" value="reader" />
                <node concept="3uibUv" id="GHHs3TAcs2" role="1tU5fm">
                  <ref role="3uigEE" to="guwi:~BufferedReader" resolve="BufferedReader" />
                </node>
                <node concept="2ShNRf" id="GHHs3TAcs3" role="33vP2m">
                  <node concept="1pGfFk" id="GHHs3TAcs4" role="2ShVmc">
                    <ref role="37wK5l" to="guwi:~BufferedReader.&lt;init&gt;(java.io.Reader)" resolve="BufferedReader" />
                    <node concept="2ShNRf" id="GHHs3TAcs5" role="37wK5m">
                      <node concept="1pGfFk" id="GHHs3TAcs6" role="2ShVmc">
                        <ref role="37wK5l" to="guwi:~InputStreamReader.&lt;init&gt;(java.io.InputStream)" resolve="InputStreamReader" />
                        <node concept="37vLTw" id="GHHs3TAcs7" role="37wK5m">
                          <ref role="3cqZAo" node="GHHs3TAcrV" resolve="input_stream" />
                        </node>
                      </node>
                    </node>
                  </node>
            ...
            <node concept="3cpWs8" id="GHHs3TAcs8" role="3cqZAp">
              <node concept="3cpWsn" id="GHHs3TAcs9" role="3cpWs9">
                <property role="TrG5h" value="line" />
                <node concept="17QB3L" id="GHHs3TAcsa" role="1tU5fm" />
                <node concept="10Nm6u" id="GHHs3TAcsb" role="33vP2m" />
              </node>
            </node>
            <node concept="2$JKZl" id="GHHs3TAcsc" role="3cqZAp">
              <node concept="3clFbS" id="GHHs3TAcsd" role="2LFqv$">
                <node concept="3clFbF" id="GHHs3TAcse" role="3cqZAp">
                  <node concept="2OqwBi" id="GHHs3TAcsf" role="3clFbG">
                    <node concept="10M0yZ" id="GHHs3TAcsg" role="2Oq$k0">
                      <ref role="1PxDUh" to="wyt6:~System" resolve="System" />
                      <ref role="3cqZAo" to="wyt6:~System.out" resolve="out" />
                    </node>
                    <node concept="liA8E" id="GHHs3TAcsh" role="2OqNvi">
                      <ref role="37wK5l" to="guwi:~PrintStream.println(java.lang.String)" resolve="println" />
                      <node concept="37vLTw" id="GHHs3TAcsi" role="37wK5m">
                        <ref role="3cqZAo" node="GHHs3TAcs9" resolve="line" />
                      </node>
                    </node>
                  </node>
                </node>
              </node>
              <node concept="3y3z36" id="GHHs3TAcsj" role="2$JKZa">
                <node concept="10Nm6u" id="GHHs3TAcsk" role="3uHU7w" />
                <node concept="1eOMI4" id="GHHs3TAcsl" role="3uHU7B">
                  <node concept="37vLTI" id="GHHs3TAcsm" role="1eOMHV">
                    <node concept="2OqwBi" id="GHHs3TAcsn" role="37vLTx">
                      <node concept="37vLTw" id="GHHs3TAcso" role="2Oq$k0">
                        <ref role="3cqZAo" node="GHHs3TAcs1" resolve="reader" />
                      </node>
                      <node concept="liA8E" id="GHHs3TAcsp" role="2OqNvi">
                        <ref role="37wK5l" to="guwi:~BufferedReader.readLine()" resolve="readLine" />
                      </node>
                    </node>
                    <node concept="37vLTw" id="GHHs3TAcsq" role="37vLTJ">
                      <ref role="3cqZAo" node="GHHs3TAcs9" resolve="line" />
                    </node>
                  </node>
                </node>
            ...
            <node concept="3cpWs8" id="GHHs3TAcsr" role="3cqZAp">
              <node concept="3cpWsn" id="GHHs3TAcss" role="3cpWs9">
                <property role="TrG5h" value="exit_code" />
                <node concept="10Oyi0" id="GHHs3TAcst" role="1tU5fm" />
                <node concept="2OqwBi" id="GHHs3TAcsu" role="33vP2m">
                  <node concept="37vLTw" id="GHHs3TAcsv" role="2Oq$k0">
                    <ref role="3cqZAo" node="GHHs3TAcrP" resolve="p" />
                  </node>
                  <node concept="liA8E" id="GHHs3TAcsw" role="2OqNvi">
                    <ref role="37wK5l" to="wyt6:~Process.waitFor()" resolve="waitFor" />
                  </node>
                </node>
              </node>
          ...
          <node concept="1wplmZ" id="GHHs3TAcsx" role="1zxBo6">
            <node concept="3clFbS" id="GHHs3TAcsy" role="1wplMD">
              <node concept="3clFbF" id="GHHs3TAcsz" role="3cqZAp">
                <node concept="2OqwBi" id="GHHs3TAcs$" role="3clFbG">
                  <node concept="10M0yZ" id="GHHs3TAcs_" role="2Oq$k0">
                    <ref role="3cqZAo" to="wyt6:~System.out" resolve="out" />
                    <ref role="1PxDUh" to="wyt6:~System" resolve="System" />
                  </node>
                  <node concept="liA8E" id="GHHs3TAcsA" role="2OqNvi">
                    <ref role="37wK5l" to="guwi:~PrintStream.println(java.lang.String)" resolve="println" />
                    <node concept="Xl_RD" id="GHHs3TAcsB" role="37wK5m">
                      <property role="Xl_RC" value="Build completed successfully." />
                    </node>
                  </node>
                </node>
        ...
        <node concept="3clFbH" id="GHHs3TAbxh" role="3cqZAp" />
