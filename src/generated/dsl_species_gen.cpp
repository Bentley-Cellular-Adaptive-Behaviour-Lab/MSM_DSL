...
*/
  ...
  // PARAMS:DLL4_NOTCH_ON_1,  VEGF_VEGFR_ON_1,  VEGF_VEGFR_OFF_1,  DEG_RATE_1,  PROD_RATE_1,  DLL4_NOTCH_DEG_1,  DLL4_DEG_1,  DLL4_UPTAKE_1,  VEGFR_DEG_1,  VEGF_VEGFR2_DEG_1,  NOTCH_DEG_1,  DLL4_REMOVAL_1,  DLL4_UPREG_10,  VEGFR_INHIB_10,  
  ...
  // ODE Definitions
  	dxdt[0] = +(PROD_RATE_9)-(NOTCH_DEG_9)-(DLL4_NOTCH_ON_9)*1-(DLL4_NOTCH_ON_9)*1; // NOTCH_1
  	dxdt[1] = -(DLL4_NOTCH_DEG_9)+(DLL4_NOTCH_ON_9)*1; // DLL4_NOTCH_1
  	dxdt[2] = -(DLL4_REMOVAL_9)+(DLL4_UPREG_0); // DLL4_1
  ...
  void ODEs::EndothelialType_run_cell_only_ODEs(EC *ec) {
  	...
  	states[1] = ec->get_cell_protein_level("DLL4_NOTCH", 9);  //DLL4_NOTCH_1
  	states[2] = ec->get_cell_protein_level("DLL4", 9);  //DLL4_1
  	...
  	ec->set_cell_protein_level("DLL4_NOTCH", states[1], 10);
  	ec->set_cell_protein_level("DLL4", states[2], 10);
