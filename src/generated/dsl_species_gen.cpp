...
void ODEs::check_cell_only_ODEs(EC *ec) {
 ...
 // Params: DLL4_UPREG VEGFR_INHIB DEG_RATE DLL4_UPTAKE DLL4_DEG DLL4_NOTCH_DEG_RATE VEGFR_DEG PROD_RATE NOTCH_DEG VEGF_VEGFR2_DEG DLL4_REMOVAL DLL4_NOTCH_DEG 
 ...
 /*
 	...
 	double DLL4_NOTCH_DEG_RATE = calc_DLL4_NOTCH_DEG_RATE_rate(false);
 	...
 	double DLL4_NOTCH_DEG = calc_DLL4_NOTCH_DEG_rate(DLL4_NOTCH, DLL4_NOTCH_DEG_RATE, false);
 	// ODE Definitions
...
*/
  ...
  // PARAMS:DLL4_NOTCH_ON_1,  VEGF_VEGFR_ON_1,  VEGF_VEGFR_OFF_1,  DEG_RATE_1,  PROD_RATE_1,  DLL4_NOTCH_DEG_RATE_1,  DLL4_DEG_1,  DLL4_UPTAKE_1,  VEGFR_DEG_1,  VEGF_VEGFR2_DEG_1,  NOTCH_DEG_1,  DLL4_NOTCH_DEG_1,  DLL4_REMOVAL_1,  DLL4_UPREG_30,  VEGFR_INHIB_30,  
  ...
  // Parameter Definitions
  	...
  	double DLL4_NOTCH_DEG_RATE_29 = calc_DLL4_NOTCH_DEG_RATE_rate(false);
  	...
  	double NOTCH_DEG_29 = calc_NOTCH_DEG_rate(NOTCH_29, DEG_RATE_29, false);
  	double DLL4_NOTCH_DEG_29 = calc_DLL4_NOTCH_DEG_rate(DLL4_NOTCH_29, DLL4_NOTCH_DEG_RATE_29, false);
  ...
  // ODE Definitions
  	dxdt[0] = +(PROD_RATE_29)-(NOTCH_DEG_29)-(DLL4_NOTCH_ON_29)*1-(DLL4_NOTCH_ON_29)*1; // NOTCH_1
