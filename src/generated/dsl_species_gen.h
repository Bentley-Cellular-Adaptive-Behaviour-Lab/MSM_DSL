...
typedef boost::array<double, 12> Endothelial_cell_ode_states;
typedef boost::array<double, 12> Endothelial_memAgent_ode_states;
typedef boost::array<double, 12> Endothelial_cell_only_ode_states;
