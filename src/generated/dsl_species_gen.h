...
static double calc_v5_inverse_rate(double k2_inverse, double DLL4_MEAN, double NOTCH, const bool memAgent) {
	auto expr = k2_inverse*DLL4_MEAN*NOTCH;
	return expr;
}

static double calc_k2_inverse_rate(const bool memAgent) {
	auto expr = 0.001;
	return expr;
}

static double calc_v6_inverse_rate(double k_2_inverse, double DLL4_NOTCH, const bool memAgent) {
	auto expr = k_2_inverse*DLL4_NOTCH;
	return expr;
}

static double calc_k_2_inverse_rate(const bool memAgent) {
	auto expr = 0.1;
	return expr;
}
