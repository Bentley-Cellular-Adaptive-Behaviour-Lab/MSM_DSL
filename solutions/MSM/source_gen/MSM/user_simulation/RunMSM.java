...
public class RunMSM {
  public static void main(String[] args) {
    ...
    String output_string = "/Users/meadt/MPSProjects/MSM_DSL/solutions/MSM/source_gen/MSM/user_simulation";
    ...
    try {
      System.out.println("Passing build command: " + "sh buildSpringAgent.sh " + "true" + " " + "no_analysis" + " " + "1000" + " " + "30");
      ProcessBuilder pb = new ProcessBuilder("sh", "buildSpringAgent.sh", "true", "no_analysis", "1000", "30");
